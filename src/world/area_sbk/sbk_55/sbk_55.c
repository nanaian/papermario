...
s32 pad_000054[3];
s32 pad_00029C[1];
Script N(script_ExitWalk_80240320);
Script N(script_ExitWalk_8024037C);
Script N(script_ExitWalk_802403D8);
Script N(script_ExitWalk_80240434);
Script N(script_80240490);
Script N(main);
s32 pad_00063C[1];
Script N(script_NpcAI_80240670);
StaticNpc N(npcGroup_802406C8)[1];
StaticNpc N(npcGroup_802408B8)[1];
NpcGroupList N(npcGroupList_80240AA8);
s32 pad_000ACC[1];
Script N(script_SearchBush_80240AD0);
Script N(script_ShakeTree_80240E30);
s32 N(treeDropList_Tree1)[8];
Script N(script_80241488);
Script N(script_MakeEntities);
s32 pad_001548[2];
const char D_80241550_953FA0[8]; // "sbk_54"
const char D_80241558_953FA8[8]; // "sbk_56"
const char D_80241560_953FB0[8]; // "sbk_45"
const char D_80241568_953FB8[8]; // "sbk_65"

// text: func_80240000_952A50

s32 pad_000038[] = {
    0x00000000, 0x00000000,
};

// text: func_80240040_952A90

s32 pad_000054[] = {
    0x00000000, 0x00000000, 0x00000000,
};

// text: func_80240060_952AB0

// text: func_802400D0_952B20
...
Script N(script_ExitWalk_80240320) = SCRIPT({
    group 27;
    UseExitHeading(60, 0);
    spawn ExitWalk;
    GotoMap(D_80241550_953FA0, 1);
    sleep 100;
});

Script N(script_ExitWalk_8024037C) = SCRIPT({
    group 27;
    UseExitHeading(60, 1);
    spawn ExitWalk;
    GotoMap(D_80241558_953FA8, 0);
    sleep 100;
});

Script N(script_ExitWalk_802403D8) = SCRIPT({
    group 27;
    UseExitHeading(60, 2);
    spawn ExitWalk;
    GotoMap(D_80241560_953FB0, 3);
    sleep 100;
});

Script N(script_ExitWalk_80240434) = SCRIPT({
    group 27;
    UseExitHeading(60, 3);
    spawn ExitWalk;
    GotoMap(D_80241568_953FB8, 2);
    sleep 100;
});

Script N(script_80240490) = SCRIPT({
    bind N(script_ExitWalk_80240320) to 0x80000 9;
    bind N(script_ExitWalk_8024037C) to 0x80000 5;
    bind N(script_ExitWalk_802403D8) to 0x80000 3;
    bind N(script_ExitWalk_80240434) to 0x80000 7;
});
...
Script N(main) = SCRIPT({
    ...
    MakeNpcs(0, N(npcGroupList_80240AA8));
    await N(script_MakeEntities);
    func_80240000_952A50();
    SetMusicTrack(0, 23, 0, 8);
    SI_VAR(0) = N(script_80240490);
    spawn EnterWalk;
    spawn N(script_80241488);
});
...
NpcAISettings N(aISettings_80240640) = {
    .moveSpeed = 1.8f,
    .moveTime = 0x32,
    .waitTime = 0xA,
    .alertRadius = 250.0f,
...
Script N(script_NpcAI_80240670) = SCRIPT({
    func_80240040_952A90();
    DoBasicAI(N(aISettings_80240640));
});

NpcSettings N(npcSettings_8024069C) = {
    .unk_00 = { 0, 0, 0, 0 },
    .height = 0x48,
    .radius = 0xF,
    .otherAI = NULL,
    .onInteract = NULL,
    .ai = &N(script_NpcAI_80240670),
    .onHit = &EnemyNpcHit,
    .aux = NULL,
...
StaticNpc N(npcGroup_802406C8)[] = {
    {
        .id = 0,
        .settings = &N(npcSettings_8024069C),
        .pos = { 43.0, 0.0, -120.0 },
        .flags = 0x00002800,
        .yaw = 270,
        .dropFlags = 0x80,
        ...
        .movement = { 0x0000002B, 0x00000000, 0xFFFFFF88, 0x0000001E, 0x00000000, 0xFFFF8001, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x000003E8, 0x00000000, 0x00000000, 0x00000001 },
        .animations = {
...
StaticNpc N(npcGroup_802408B8)[] = {
    {
        ...
        .itemDropChance = 15,
        .itemDrops = { { ItemId_DRIED_FRUIT, 9 }, { ItemId_TASTY_TONIC, 1 } },
        .movement = { 0xFFFFFF9C, 0x00000000, 0xFFFFFF88, 0x0000001E, 0x00000000, 0xFFFF8001, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x000003E8, 0x00000000, 0x00000000, 0x00000001 },
        .animations = {
            0x00310004, 0x00310008, 0x00310008, 0x00310008, 0x00310004, 0x00310004, 0x0031000C, 0x0031000C, 0x00310008, 0x00310008, 0x00310008, 0x00310008, 0x00310008, 0x00310008, 0x00310008, 0x00310008,
        },
    },
...
NpcGroupList N(npcGroupList_80240AA8) = {
    NPC_GROUP(N(npcGroup_802406C8), 0x0A020001),
    NPC_GROUP(N(npcGroup_802408B8), 0x0A030001),
    {},
};
        ...
        SI_CMD(ScriptOpcode_IF_NE, SI_VAR(1), 0),
            SI_CMD(ScriptOpcode_LOOP, 5),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(2)),
                    ...
                    SI_CMD(ScriptOpcode_CALL, func_802400D0_952B20, SI_VAR(3), SI_FIXED(0.1005859375), 1, SI_VAR(15), 0),
    ...
    SI_CMD(ScriptOpcode_SPAWN_THREAD),
        ...
        SI_CMD(ScriptOpcode_IF_NE, SI_VAR(1), 0),
            ...
            SI_CMD(ScriptOpcode_LOOP, 5),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(2)),
                    SI_CMD(ScriptOpcode_BUFFER_READ_1, SI_VAR(3)),
                    SI_CMD(ScriptOpcode_CALL, func_802400D0_952B20, SI_VAR(3), SI_FIXED(0.1005859375), SI_FIXED(0.2001953125), SI_VAR(15), 0),
                    SI_CMD(ScriptOpcode_IF_EQ, SI_FLAG(0), 0),
                        SI_CMD(ScriptOpcode_SET, SI_FLAG(0), 1),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(2)),
                    SI_CMD(ScriptOpcode_BUFFER_READ_1, SI_VAR(3)),
                    SI_CMD(ScriptOpcode_CALL, func_802400D0_952B20, SI_VAR(3), SI_FIXED(0.1005859375), SI_FIXED(-0.19921875), SI_VAR(15), 0),
                SI_CMD(ScriptOpcode_END_LOOP),
                SI_CMD(ScriptOpcode_SLEEP_FRAMES, 1),
            SI_CMD(ScriptOpcode_END_LOOP),
            SI_CMD(ScriptOpcode_USE_BUFFER, SI_VAR(1)),
    ...
    SI_CMD(ScriptOpcode_SPAWN_THREAD),
        ...
        SI_CMD(ScriptOpcode_IF_NE, SI_VAR(2), 0),
            SI_CMD(ScriptOpcode_LOOP, 5),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(3)),
                    SI_CMD(ScriptOpcode_BUFFER_READ_1, SI_VAR(4)),
                    SI_CMD(ScriptOpcode_CALL, func_802400D0_952B20, SI_VAR(4), SI_FIXED(0.1005859375), SI_FIXED(0.2001953125), SI_VAR(15), 0),
                    SI_CMD(ScriptOpcode_IF_EQ, SI_FLAG(0), 0),
                        SI_CMD(ScriptOpcode_SET, SI_FLAG(0), 1),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(3)),
                    SI_CMD(ScriptOpcode_BUFFER_READ_1, SI_VAR(4)),
                    SI_CMD(ScriptOpcode_CALL, func_802400D0_952B20, SI_VAR(4), SI_FIXED(0.1005859375), SI_FIXED(-0.19921875), SI_VAR(15), 0),
                SI_CMD(ScriptOpcode_END_LOOP),
                SI_CMD(ScriptOpcode_SLEEP_FRAMES, 1),
            SI_CMD(ScriptOpcode_END_LOOP),
            SI_CMD(ScriptOpcode_USE_BUFFER, SI_VAR(2)),
...
s32 N(treeDropList_Tree1)[] = {
    0x00000001, 0x00000157, 0x0000004D, 0x00000064, 0xFFFFFF9B, 0x0000000F, 0xF8405ECD, 0x00000000,
};
...
Vec4f N(triggerCoord_80241478) =  { 77.0f, 0.0f, -126.0f, 0.0f };

Script N(script_80241488) = SCRIPT({
    SI_VAR(0) = N(shakeTreeEvent_Tree1);
    bind N(script_ShakeTree_80240E30) to TriggerFlag_WALL_HAMMER 17;
    bind N(script_ShakeTree_80240E30) to TriggerFlag_BOMB N(triggerCoord_80241478);
});

Script N(script_MakeEntities) = SCRIPT({
    MakeEntity(D_802EA0E8, 0, 60, 0xFFFFFF9C, 0, 0x80000000);
    AssignBlockFlag(SI_SAVE_FLAG(822));
    MakeItemEntity(137, 420, 0, 168, 17, SI_SAVE_FLAG(836));
});
...
// rodata: D_80241550_953FA0

// rodata: D_80241558_953FA8

// rodata: D_80241560_953FB0

// rodata: D_80241568_953FB8
