...
Script N(script_ExitWalk_802404B8);
Script N(script_ExitWalk_80240514);
Script N(script_80240570);
Script N(main);
s32 pad_00071C[1];
Script N(script_80240720);
Script N(script_NpcAI_802407E8);
Script N(script_80240808);
StaticNpc N(npcGroup_80240A80)[1];
StaticNpc N(npcGroup_80240C70)[1];
NpcGroupList N(npcGroupList_80240E60);
s32 pad_000E84[3];
Script N(script_SearchBush_80240E90);
Script N(script_ShakeTree_802411F0);
Script N(script_8024185C);
s32 pad_0018FC[1];
Script N(script_MakeEntities);
s32 pad_001A2C[1];
const char D_80241A30_93DCB0[8]; // "sbk_24"
const char D_80241A38_93DCB8[8]; // "sbk_26"
const char D_80241A40_93DCC0[8]; // "sbk_15"
const char D_80241A48_93DCC8[8]; // "sbk_35"

// text: func_80240000_93C280

s32 pad_000038[] = {
    0x00000000, 0x00000000,
};

// text: func_80240040_93C2C0

// text: func_80240140_93C3C0

// text: func_802401B0_93C430
...
Script N(script_ExitWalk_8024045C) = SCRIPT({
    ...
    UseExitHeading(60, 1);
    spawn ExitWalk;
    GotoMap(D_80241A38_93DCB8, 0);
    sleep 100;
});

Script N(script_ExitWalk_802404B8) = SCRIPT({
    group 27;
    UseExitHeading(60, 2);
    spawn ExitWalk;
    GotoMap(D_80241A40_93DCC0, 3);
    sleep 100;
});

Script N(script_ExitWalk_80240514) = SCRIPT({
    group 27;
    UseExitHeading(60, 3);
    spawn ExitWalk;
    GotoMap(D_80241A48_93DCC8, 2);
    sleep 100;
});

Script N(script_80240570) = SCRIPT({
    bind N(script_ExitWalk_80240400) to 0x80000 9;
    bind N(script_ExitWalk_8024045C) to 0x80000 5;
    bind N(script_ExitWalk_802404B8) to 0x80000 3;
    bind N(script_ExitWalk_80240514) to 0x80000 7;
});
...
Script N(main) = SCRIPT({
    ...
    MakeNpcs(0, N(npcGroupList_80240E60));
    await N(script_MakeEntities);
    func_80240000_93C280();
    SetMusicTrack(0, 23, 0, 8);
    SI_VAR(0) = N(script_80240570);
    spawn EnterWalk;
...
Script N(script_80240720) = SCRIPT({
    ...
    func_80240040_93C2C0(SI_VAR(10), SI_VAR(0), SI_AREA_FLAG(1));
    RemoveItemEntity(SI_VAR(0));
});

NpcAISettings N(aISettings_802407B8) = {
    .moveSpeed = 2.7f,
    .moveTime = 0x2D,
    .waitTime = 0x1E,
    .alertRadius = 450.0f,
...
Script N(script_NpcAI_802407E8) = SCRIPT({
    DoBasicAI(N(aISettings_802407B8));
});
...
NpcSettings N(npcSettings_80240A54) = {
    .unk_00 = { 0, 0, 0, 0 },
    .height = 0x1A,
    .radius = 0x18,
    .otherAI = NULL,
    .onInteract = NULL,
    .ai = &N(script_NpcAI_802407E8),
    .onHit = &EnemyNpcHit,
    .aux = NULL,
    .onDefeat = &N(script_80240808),
    .flags = 0,
    .unk_24 = { 0, 0, 0, 0 },
    .level = 0x9,
    .unk_2A = 0x5,
...
StaticNpc N(npcGroup_80240A80)[] = {
    {
        .id = 0,
        .settings = &N(npcSettings_80240A54),
        .pos = { -80.0, 0.0, -20.0 },
        .flags = 0x00002C00,
        .yaw = 90,
        .dropFlags = 0x80,
        ...
        .movement = { 0xFFFFFFB0, 0x00000000, 0xFFFFFFEC, 0x00000064, 0x00000000, 0xFFFF8001, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x000003E8, 0x00000000, 0x00000000, 0x00000001 },
        .animations = {
...
StaticNpc N(npcGroup_80240C70)[] = {
    {
        ...
        .itemDropChance = 5,
        .itemDrops = { { ItemId_HONEY_SYRUP, 10 } },
        .movement = { 0x00000078, 0x00000000, 0x00000014, 0x00000064, 0x00000000, 0xFFFF8001, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x000003E8, 0x00000000, 0x00000000, 0x00000001 },
        .animations = {
            0x00320001, 0x00320005, 0x00320007, 0x00320007, 0x00320001, 0x00320001, 0x00320009, 0x00320009, 0x00320000, 0x00320000, 0x00320000, 0x00320000, 0x00320000, 0x00320000, 0x00320000, 0x00320000,
        },
    },
...
NpcGroupList N(npcGroupList_80240E60) = {
    NPC_GROUP(N(npcGroup_80240A80), 0x0A0A0001),
    NPC_GROUP(N(npcGroup_80240C70), 0x0A0A0001),
    {},
};
        ...
        SI_CMD(ScriptOpcode_IF_NE, SI_VAR(1), 0),
            SI_CMD(ScriptOpcode_LOOP, 5),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(2)),
                    ...
                    SI_CMD(ScriptOpcode_CALL, func_802401B0_93C430, SI_VAR(3), SI_FIXED(0.1005859375), 1, SI_VAR(15), 0),
    ...
    SI_CMD(ScriptOpcode_SPAWN_THREAD),
        ...
        SI_CMD(ScriptOpcode_IF_NE, SI_VAR(1), 0),
            ...
            SI_CMD(ScriptOpcode_LOOP, 5),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(2)),
                    SI_CMD(ScriptOpcode_BUFFER_READ_1, SI_VAR(3)),
                    SI_CMD(ScriptOpcode_CALL, func_802401B0_93C430, SI_VAR(3), SI_FIXED(0.1005859375), SI_FIXED(0.2001953125), SI_VAR(15), 0),
                    SI_CMD(ScriptOpcode_IF_EQ, SI_FLAG(0), 0),
                        SI_CMD(ScriptOpcode_SET, SI_FLAG(0), 1),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(2)),
                    SI_CMD(ScriptOpcode_BUFFER_READ_1, SI_VAR(3)),
                    SI_CMD(ScriptOpcode_CALL, func_802401B0_93C430, SI_VAR(3), SI_FIXED(0.1005859375), SI_FIXED(-0.19921875), SI_VAR(15), 0),
                SI_CMD(ScriptOpcode_END_LOOP),
                SI_CMD(ScriptOpcode_SLEEP_FRAMES, 1),
            SI_CMD(ScriptOpcode_END_LOOP),
            SI_CMD(ScriptOpcode_USE_BUFFER, SI_VAR(1)),
    ...
    SI_CMD(ScriptOpcode_SPAWN_THREAD),
        ...
        SI_CMD(ScriptOpcode_IF_NE, SI_VAR(2), 0),
            SI_CMD(ScriptOpcode_LOOP, 5),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(3)),
                    SI_CMD(ScriptOpcode_BUFFER_READ_1, SI_VAR(4)),
                    SI_CMD(ScriptOpcode_CALL, func_802401B0_93C430, SI_VAR(4), SI_FIXED(0.1005859375), SI_FIXED(0.2001953125), SI_VAR(15), 0),
                    SI_CMD(ScriptOpcode_IF_EQ, SI_FLAG(0), 0),
                        SI_CMD(ScriptOpcode_SET, SI_FLAG(0), 1),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(3)),
                    SI_CMD(ScriptOpcode_BUFFER_READ_1, SI_VAR(4)),
                    SI_CMD(ScriptOpcode_CALL, func_802401B0_93C430, SI_VAR(4), SI_FIXED(0.1005859375), SI_FIXED(-0.19921875), SI_VAR(15), 0),
                SI_CMD(ScriptOpcode_END_LOOP),
                SI_CMD(ScriptOpcode_SLEEP_FRAMES, 1),
            SI_CMD(ScriptOpcode_END_LOOP),
            SI_CMD(ScriptOpcode_USE_BUFFER, SI_VAR(2)),
...
Vec4f N(triggerCoord_80241818) =  { -398.0f, 0.0f, -104.0f, 0.0f };
...
Vec4f N(triggerCoord_8024184C) =  { -238.0f, 0.0f, -179.0f, 0.0f };

Script N(script_8024185C) = SCRIPT({
    SI_VAR(0) = N(shakeTreeEvent_Tree1);
    bind N(script_ShakeTree_802411F0) to TriggerFlag_WALL_HAMMER 17;
    bind N(script_ShakeTree_802411F0) to TriggerFlag_BOMB N(triggerCoord_80241818);
    SI_VAR(0) = N(shakeTreeEvent_Tree2);
    bind N(script_ShakeTree_802411F0) to TriggerFlag_WALL_HAMMER 18;
    bind N(script_ShakeTree_802411F0) to TriggerFlag_BOMB N(triggerCoord_8024184C);
});
...
Script N(script_MakeEntities) = SCRIPT({
    ...
    AssignBlockFlag(SI_SAVE_FLAG(818));
    MakeEntity(D_802EA0E8, 120, 60, 185, 0, 0x80000000);
    AssignBlockFlag(SI_SAVE_FLAG(819));
    MakeEntity(D_802EA0C4, 0xFFFFFED4, 60, 0xFFFFFFB0, 0, 0x80000000);
    MakeEntity(D_802EA0C4, 0xFFFFFF10, 60, 230, 0, 0x80000000);
    MakeEntity(D_802EA0C4, 0xFFFFFFB5, 60, 295, 0, 0x80000000);
    MakeEntity(D_802EA0C4, 0xFFFFFFB5, 60, 0xFFFFFE98, 0, 0x80000000);
    MakeEntity(D_802EA0C4, 270, 60, 0xFFFFFF6A, 0, 0x80000000);
});
...
// rodata: D_80241A30_93DCB0

// rodata: D_80241A38_93DCB8

// rodata: D_80241A40_93DCC0

// rodata: D_80241A48_93DCC8
