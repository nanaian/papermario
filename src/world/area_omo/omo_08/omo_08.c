...
Script N(script_MakeEntities) = SCRIPT({
    MakeEntity(D_802E9A18, 0xFFFFFEA2, 60, 50, 0, 0x80000000);
    MakeEntity(D_802EA588, 350, 60, 60, 0, 128, 0x80000000);
    AssignBlockFlag(SI_SAVE_FLAG(1145));
    MakeEntity(D_802EAB04, 0xFFFFFF38, 0, 200, 0, 20, 0x80000000);
