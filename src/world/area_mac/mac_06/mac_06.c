...
Script N(script_80242A14) = SCRIPT({
    group 0;
    func_802C9C70(1, 10, 1);
    func_802C94A0(1, func_802408D0_865410, 0);
    func_802C90FC(10, 1, -1);
    func_802C9C70(2, 11, 1);
    func_802C94A0(2, func_80240974_8654B4, 0);
    func_802C90FC(11, 2, -1);
    SetNpcVar(0, 0, 0);
    spawn {
    0:
