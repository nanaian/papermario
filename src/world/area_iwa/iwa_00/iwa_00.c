...
Script N(script_MakeEntities) = SCRIPT({
    if (SI_SAVE_FLAG(719) == 0) {
        MakeEntity(D_802EA154, 900, 0xFFFFFFE2, 220, 0, 0x80000000);
    ...
    MakeEntity(D_802EA564, 1260, 30, 140, 0, 143, 0x80000000);
    AssignBlockFlag(SI_SAVE_FLAG(715));
    MakeEntity(D_802BCD9C, 58, 0xFFFFFFFB, 0xFFFFFFB7, 0xFFFFFFE2, 90, 0x80000000);
    MakeEntity(D_802BCD9C, 926, 70, 0xFFFFFFD3, 22, 90, 0x80000000);
});
