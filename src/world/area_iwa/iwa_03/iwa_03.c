...
Script N(script_MakeEntities) = SCRIPT({
    ...
    MakeEntity(D_802EAA30, 0xFFFFF9D4, 23, 20, 0, 0x80000000);
    AssignScript(N(script_802416E0));
    MakeEntity(D_802EA564, 0xFFFFF911, 408, 0xFFFFFF88, 0, 343, 0x80000000);
    AssignBlockFlag(SI_SAVE_FLAG(702));
    MakeEntity(D_802EA564, 0xFFFFFD94, 0xFFFFFFF1, 0xFFFFFFBB, 0, 138, 0x80000000);
    AssignBlockFlag(SI_SAVE_FLAG(703));
    MakeEntity(D_802EA564, 0xFFFFFBBE, 408, 0xFFFFFF7E, 0, 164, 0x80000000);
    ...
    MakeEntity(D_802EAE30, 0xFFFFF94B, 93, 0xFFFFFF81, 0, 0, 0x80000000);
