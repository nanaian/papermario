...
StaticNpc N(npcGroup_802407EC)[1];
StaticNpc N(npcGroup_802409DC)[1];
NpcGroupList N(npcGroupList_80240BCC);
Script N(script_80240BF0);
Script N(script_MakeEntities);
s32 pad_000C7C[1];
const char D_80240C80_BFA090[8]; // "arn_12"
const char D_80240C88_BFA098[8]; // "arn_11"
...
NpcGroupList N(npcGroupList_80240BCC) = {
    NPC_GROUP(N(npcGroup_802407EC), 0x00000000),
    NPC_GROUP(N(npcGroup_802409DC), 0x0E020005),
    {},
};

Script N(script_80240BF0) = SCRIPT({
    DisablePlayerInput(1);
    ShowMessageAtScreenPos(0x1D0184, 160, 40);
