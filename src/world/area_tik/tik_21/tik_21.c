...
Script N(script_MakeEntities) = SCRIPT({
    MakeEntity(D_802EA564, 0xFFFFFF63, 0xFFFFFFD3, 0, 0, 343, 0x80000000);
    AssignBlockFlag(SI_SAVE_FLAG(411));
    MakeEntity(D_802EA588, 0xFFFFFFAE, 0xFFFFFFD3, 0, 0, 343, 0x80000000);
    AssignBlockFlag(SI_SAVE_FLAG(412));
    MakeEntity(D_802EA588, 0xFFFFFFF9, 0xFFFFFFD3, 0, 0, 343, 0x80000000);
    AssignBlockFlag(SI_SAVE_FLAG(413));
    MakeEntity(D_802EA588, 68, 0xFFFFFFD3, 0, 0, 343, 0x80000000);
    AssignBlockFlag(SI_SAVE_FLAG(414));
    MakeEntity(D_802EA588, 142, 0xFFFFFFD3, 0, 0, 343, 0x80000000);
