...
Script N(script_MakeEntities) = SCRIPT({
    MakeEntity(D_802EA07C, 90, 70, 0xFFFFFF2E, 0, 0x80000000);
    MakeEntity(D_802EA07C, 130, 80, 0xFFFFFF2E, 0, 0x80000000);
    MakeEntity(D_802EA07C, 170, 90, 0xFFFFFF2E, 0, 0x80000000);
    MakeEntity(D_802EA07C, 210, 100, 0xFFFFFF2E, 0, 0x80000000);
    MakeEntity(D_802EA07C, 250, 110, 0xFFFFFF2E, 0, 0x80000000);
    MakeEntity(D_802EAE0C, 193, 0, 0xFFFFFFDA, 0xFFFFFFEC, 0, 0x80000000);
    MakeEntity(D_802EAE30, 130, 0, 0xFFFFFFDA, 0xFFFFFFEC, 0, 0x80000000);
});
