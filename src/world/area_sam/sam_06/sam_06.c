...
s32 pad_000548[2];
s32 unk_missing_802420C4[19];
s32 unk_missing_80242244[2];
s32 pad_00261C[1];
Script N(script_80242670);
Script N(script_8024269C);
s32 pad_0026C8[2];
Script N(script_UpdateTexturePan_802426D0);
Script N(script_SearchBush_8024276C);
Script N(script_ShakeTree_80242ACC);
Script N(script_ExitWalk_802431D4);
Script N(script_80243230);
Script N(script_8024325C);
Script N(script_8024334C);
Script N(main);
Script N(script_OpenDoor_80243970);
Script N(script_MoveWalls_802439A0);
Script N(script_ToggleVis_80243A48);
Script N(script_OpenDoor_80243ACC);
Script N(script_MoveWalls_80243AFC);
Script N(script_ToggleVis_80243BA4);
Script N(script_OpenDoor_80243C94);
Script N(script_MoveWalls_80243CC4);
Script N(script_ToggleVis_80243E34);
s32 N(npcList_80243EB8)[2];
s32 N(npcList_80243EC0)[2];
s32 N(npcList_80243EC8)[5];
Script N(script_80243EDC);
s32 pad_003FB8[2];
Script N(script_80243FF0);
s32 unk_missing_80244010[22];
Script N(script_NpcAI_80244098);
Script N(script_NpcAI_80244114);
s32 unk_missing_8024418C[11];
f32 N(floatTable_802441B8)[6];
Script N(script_NpcAI_80244200);
s32 unk_missing_80244270[11];
s32 unk_missing_802442C8[22];
s32 unk_missing_8024434C[11];
s32 N(unk_802443D0)[1];
Script N(script_802443D4);
Script N(script_80244404);
s32 N(unk_80244434)[1];
s32 N(unk_80244438)[1];
Script N(script_8024443C);
Script N(script_80244580);
Script N(script_802445D0);
Script N(script_80244704);
s32 N(unk_80244754)[11];
s32 N(unk_80244780)[11];
s32 N(unk_802447AC)[11];
s32 N(unk_802447D8)[11];
s32 N(unk_80244804)[11];
s32 N(unk_80244830)[11];
s32 N(unk_8024485C)[11];
s32 N(unk_80244888)[11];
s32 N(unk_802448B4)[11];
s32 N(unk_802448E0)[11];
s32 N(unk_8024490C)[11];
s32 N(unk_80244938)[11];
s32 N(unk_80244964)[11];
s32 N(unk_80244990)[11];
s32 N(unk_802449BC)[11];
s32 N(unk_802449E8)[11];
s32 N(unk_80244A14)[29];
s32 N(unk_80244A88)[200];
s32 N(unk_80244DA8)[1200];
s32 N(unk_80246068)[90];
s32 N(unk_802461D0)[445];
Script N(script_802468C4);
Script N(script_8024693C);
Script N(script_Interact_80246A94);
Script N(script_80246E3C);
Script N(script_80246EBC);
Script N(script_802471E0);
Script N(script_80247250);
s32 N(unk_80247548)[2];
Script N(script_80247550);
Script N(script_Interact_802475A0);
Script N(script_80247698);
Script N(script_802477A8);
Script N(script_802478D4);
Script N(script_80247D8C);
Script N(script_802480C4);
Script N(script_Idle_80248B98);
Script N(script_80248CE4);
Script N(script_Interact_8024932C);
Script N(script_Interact_802493A8);
Script N(script_Interact_80249424);
Script N(script_Interact_802494CC);
Script N(script_Interact_80249548);
Script N(script_Interact_802495C4);
Script N(script_Interact_80249640);
Script N(script_Interact_802496BC);
Script N(script_Interact_80249738);
Script N(script_Interact_802497B4);
Script N(script_Interact_802498DC);
Script N(script_Interact_80249958);
Script N(script_Interact_802499D4);
Script N(script_80249A50);
Script N(script_80249AB0);
Script N(script_80249D1C);
Script N(script_Init_80249DAC);
Script N(script_Init_80249E60);
Script N(script_Init_80249E84);
Script N(script_Init_80249EA8);
Script N(script_Init_80249ECC);
Script N(script_Init_80249EF0);
Script N(script_Init_80249F14);
Script N(script_Init_80249F38);
Script N(script_Init_80249F5C);
Script N(script_Init_80249F80);
Script N(script_Init_80249FA4);
Script N(script_Init_80249FFC);
Script N(script_Init_8024A020);
Script N(script_Init_8024A044);
Script N(script_Init_8024A068);
StaticNpc N(npcGroup_8024A08C)[15];
NpcGroupList N(npcGroupList_8024BD9C);
s32 pad_00BDB4[3];
Script N(script_MakeEntities);
s32 pad_00BE28[2];
const char D_8024BE30_D2BCC0[8]; // "sam_05"
s32 pad_00BE38[2];
s32 pad_00BE94[3];

// text: func_80240000_D1FE90

// text: func_80240124_D1FFB4

// text: func_8024030C_D2019C

// text: func_8024037C_D2020C

s32 pad_000548[] = {
    0x00000000, 0x00000000,
};

// text: func_80240550_D203E0

// text: func_80240700_D20590

// text: N(UnkNpcAIFunc1)

// text: func_80240DE8_D20C78

// text: N(UnkNpcAIFunc2)

// text: func_802411A4_D21034

// text: func_80241210_D210A0

// text: N(UnkNpcAIFunc3)

// text: func_802413A8_D21238

// text: func_80241738_D215C8

// text: func_8024185C_D216EC

// text: func_80241A48_D218D8

// text: func_80241AFC_D2198C

// text: func_80241B60_D219F0

// text: func_80241BBC_D21A4C

// text: func_80241D8C_D21C1C

// text: func_80241DE0_D21C70

// text: func_80241E18_D21CA8

// text: func_80241EB4_D21D44

// text: func_80241F50_D21DE0

// text: func_80241F70_D21E00

// text: func_80241F98_D21E28

// text: func_80242014_D21EA4
...
// text: func_80242110_D21FA0

// text: func_80242164_D21FF4

// text: func_802421E0_D22070

// text: func_80242214_D220A4

s32 unk_missing_80242244[] = {
    0x03E00008, 0x24020002,
};

// text: func_8024224C_D220DC

// text: func_8024233C_D221CC

// text: func_802424C8_D22358

// text: func_8024250C_D2239C

// text: func_80242538_D223C8
...
Script N(script_80242670) = SCRIPT({
    SetMusicTrack(0, 60, 0, 8);
});
...
Script N(script_UpdateTexturePan_802426D0) = SCRIPT({
    ...
    if (SI_VAR(5) == 1) {
        if (SI_VAR(6) == 1) {
            if (SI_VAR(7) == 1) {
                if (SI_VAR(8) == 1) {
                    func_80240000_D1FE90();
                    return;
                }
            }
        }
    }
    func_80240124_D1FFB4();
});
        ...
        SI_CMD(ScriptOpcode_IF_NE, SI_VAR(1), 0),
            SI_CMD(ScriptOpcode_LOOP, 5),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(2)),
                    ...
                    SI_CMD(ScriptOpcode_CALL, func_8024037C_D2020C, SI_VAR(3), SI_FIXED(0.1005859375), 1, SI_VAR(15), 0),
    ...
    SI_CMD(ScriptOpcode_SPAWN_THREAD),
        ...
        SI_CMD(ScriptOpcode_IF_NE, SI_VAR(1), 0),
            ...
            SI_CMD(ScriptOpcode_LOOP, 5),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(2)),
                    SI_CMD(ScriptOpcode_BUFFER_READ_1, SI_VAR(3)),
                    SI_CMD(ScriptOpcode_CALL, func_8024037C_D2020C, SI_VAR(3), SI_FIXED(0.1005859375), SI_FIXED(0.2001953125), SI_VAR(15), 0),
                    SI_CMD(ScriptOpcode_IF_EQ, SI_FLAG(0), 0),
                        SI_CMD(ScriptOpcode_SET, SI_FLAG(0), 1),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(2)),
                    SI_CMD(ScriptOpcode_BUFFER_READ_1, SI_VAR(3)),
                    SI_CMD(ScriptOpcode_CALL, func_8024037C_D2020C, SI_VAR(3), SI_FIXED(0.1005859375), SI_FIXED(-0.19921875), SI_VAR(15), 0),
                SI_CMD(ScriptOpcode_END_LOOP),
                SI_CMD(ScriptOpcode_SLEEP_FRAMES, 1),
            SI_CMD(ScriptOpcode_END_LOOP),
            SI_CMD(ScriptOpcode_USE_BUFFER, SI_VAR(1)),
    ...
    SI_CMD(ScriptOpcode_SPAWN_THREAD),
        ...
        SI_CMD(ScriptOpcode_IF_NE, SI_VAR(2), 0),
            SI_CMD(ScriptOpcode_LOOP, 5),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(3)),
                    SI_CMD(ScriptOpcode_BUFFER_READ_1, SI_VAR(4)),
                    SI_CMD(ScriptOpcode_CALL, func_8024037C_D2020C, SI_VAR(4), SI_FIXED(0.1005859375), SI_FIXED(0.2001953125), SI_VAR(15), 0),
                    SI_CMD(ScriptOpcode_IF_EQ, SI_FLAG(0), 0),
                        SI_CMD(ScriptOpcode_SET, SI_FLAG(0), 1),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(3)),
                    SI_CMD(ScriptOpcode_BUFFER_READ_1, SI_VAR(4)),
                    SI_CMD(ScriptOpcode_CALL, func_8024037C_D2020C, SI_VAR(4), SI_FIXED(0.1005859375), SI_FIXED(-0.19921875), SI_VAR(15), 0),
                SI_CMD(ScriptOpcode_END_LOOP),
                SI_CMD(ScriptOpcode_SLEEP_FRAMES, 1),
            SI_CMD(ScriptOpcode_END_LOOP),
            SI_CMD(ScriptOpcode_USE_BUFFER, SI_VAR(2)),
...
Vec4f N(triggerCoord_802430F4) =  { -185.0f, 90.0f, -225.0f, 0.0f };
...
Vec4f N(triggerCoord_80243128) =  { -451.0f, 60.0f, 80.0f, 0.0f };
...
Vec4f N(triggerCoord_8024315C) =  { -405.0f, 0.0f, 228.0f, 0.0f };
...
Vec4f N(triggerCoord_80243190) =  { 291.0f, 0.0f, 385.0f, 0.0f };
...
Vec4f N(triggerCoord_802431C4) =  { 108.0f, 83.0f, 115.0f, 0.0f };

Script N(script_ExitWalk_802431D4) = SCRIPT({
    group 27;
    UseExitHeading(60, 0);
    spawn ExitWalk;
    GotoMap(D_8024BE30_D2BCC0, 1);
    sleep 100;
});

Script N(script_80243230) = SCRIPT({
    bind N(script_ExitWalk_802431D4) to 0x80000 1;
});

Script N(script_8024325C) = SCRIPT({
    SI_AREA_FLAG(1) = 1;
    SI_AREA_FLAG(2) = 0;
10:
...
Script N(main) = SCRIPT({
    ...
    SI_SAVE_FLAG(1988) = 1;
    MakeNpcs(0, N(npcGroupList_8024BD9C));
    ClearDefeatedEnemies();
    await N(script_MakeEntities);
    await N(script_80242670);
    spawn N(script_8024325C);
    spawn N(script_8024334C);
    await N(script_80243EDC);
    SetRenderMode(100, 21);
    SetRenderMode(27, 21);
    ModifyColliderFlags(3, 54, 8);
    ModifyColliderFlags(3, 1, 8);
    ModifyColliderFlags(3, 43, 8);
    ModifyColliderFlags(3, 56, 8);
    ModifyColliderFlags(3, 45, 8);
    ModifyColliderFlags(3, 47, 8);
    ModifyColliderFlags(3, 48, 8);
    ModifyColliderFlags(3, 49, 8);
    ModifyColliderFlags(3, 50, 8);
    ModifyColliderFlags(3, 52, 8);
    SI_VAR(0) = N(shakeTreeEvent_Tree1);
    bind N(script_ShakeTree_80242ACC) to TriggerFlag_BOMB N(triggerCoord_802430F4);
    SI_VAR(0) = N(shakeTreeEvent_Tree2);
    bind N(script_ShakeTree_80242ACC) to TriggerFlag_BOMB N(triggerCoord_80243128);
    SI_VAR(0) = N(shakeTreeEvent_Tree3);
    bind N(script_ShakeTree_80242ACC) to TriggerFlag_BOMB N(triggerCoord_8024315C);
    SI_VAR(0) = N(shakeTreeEvent_Tree4);
    bind N(script_ShakeTree_80242ACC) to TriggerFlag_BOMB N(triggerCoord_80243190);
    SI_VAR(0) = N(shakeTreeEvent_Tree5);
    bind N(script_ShakeTree_80242ACC) to TriggerFlag_WALL_HAMMER 59;
    bind N(script_ShakeTree_80242ACC) to TriggerFlag_BOMB N(triggerCoord_802431C4);
    GetLoadType(SI_VAR(1));
    if (SI_VAR(1) == 1) {
        spawn EnterSavePoint;
        spawn N(script_80243230);
        sleep 1;
    } else {
        SI_VAR(0) = N(script_80243230);
        spawn EnterWalk;
        sleep 1;
    }
    spawn {
...
Script N(script_OpenDoor_80243970) = SCRIPT({
    RotateModel(29, SI_VAR(0), 0, -1, 0);
});

Script N(script_MoveWalls_802439A0) = SCRIPT({
    RotateGroup(28, SI_VAR(0), 0, 0, 1);
    RotateGroup(25, SI_VAR(0), 0, 0, -1);
    if (SI_VAR(0) > 89) {
        SetGroupEnabled(25, 0);
    }
    if (SI_VAR(0) < 89) {
        SetGroupEnabled(25, 1);
    }
});

Script N(script_ToggleVis_80243A48) = SCRIPT({
    match SI_VAR(0) {
        == 0 {
            SI_AREA_FLAG(1) = 0;
            SetGroupEnabled(56, 1);
        }
        == 3 {
            SI_AREA_FLAG(1) = 1;
            SetGroupEnabled(56, 0);
        }
    }
});

Script N(script_OpenDoor_80243ACC) = SCRIPT({
    RotateModel(75, SI_VAR(0), 0, -1, 0);
});

Script N(script_MoveWalls_80243AFC) = SCRIPT({
...
Script N(script_ToggleVis_80243BA4) = SCRIPT({
    match SI_VAR(0) {
        == 0 {
            SI_AREA_FLAG(1) = 0;
            SetGroupEnabled(93, 1);
            EnableModel(93, 1);
        }
        == 2 {
            if (SI_SAVE_VAR(0) < 72) {
        ...
        == 3 {
            SI_AREA_FLAG(1) = 1;
            SetGroupEnabled(93, 0);
            if (SI_SAVE_VAR(0) < 72) {
                await N(script_80248CE4);
            }
        }
    }
});

Script N(script_OpenDoor_80243C94) = SCRIPT({
    RotateModel(112, SI_VAR(0), 0, -1, 0);
});

Script N(script_MoveWalls_80243CC4) = SCRIPT({
    RotateGroup(111, SI_VAR(0), 0, 0, 1);
    RotateGroup(108, SI_VAR(0), 0, 0, -1);
    if (SI_VAR(0) > 89) {
        SetGroupEnabled(108, 0);
    ...
    if (SI_VAR(0) < 89) {
        SetGroupEnabled(108, 1);
        SetGroupEnabled(111, 1);
        EnableModel(99, 1);
        EnableModel(100, 1);
        EnableModel(102, 1);
        EnableModel(103, 1);
...
Script N(script_ToggleVis_80243E34) = SCRIPT({
    match SI_VAR(0) {
        == 0 {
            SI_AREA_FLAG(1) = 0;
...
s32 N(npcList_80243EB8)[] = {
    0x0000000E, 0xFFFFFFFF,
};

s32 N(npcList_80243EC0)[] = {
    0x00000000, 0xFFFFFFFF,
};

s32 N(npcList_80243EC8)[] = {
    0x00000007, 0x0000000B, 0x0000000C, 0x0000000D, 0xFFFFFFFF,
};

Script N(script_80243EDC) = SCRIPT({
    SetGroupEnabled(56, 0);
    MakeDoorAdvanced(2, N(script_OpenDoor_80243970), N(script_MoveWalls_802439A0), 0, N(script_ToggleVis_80243A48), 11, 12, 57, N(npcList_80243EB8));
    SetGroupEnabled(93, 0);
    MakeDoorAdvanced(2, N(script_OpenDoor_80243ACC), N(script_MoveWalls_80243AFC), 0, N(script_ToggleVis_80243BA4), 24, 25, 94, N(npcList_80243EC0));
    SetGroupEnabled(146, 0);
    MakeDoorAdvanced(2, N(script_OpenDoor_80243C94), N(script_MoveWalls_80243CC4), 0, N(script_ToggleVis_80243E34), 37, 38, 147, N(npcList_80243EC8));
});
...
NpcAISettings N(aISettings_80243FC0) = {
    .moveSpeed = 1.5f,
    .moveTime = 0x3C,
    .waitTime = 0x1E,
    .alertRadius = 0.0f,
...
Script N(script_80243FF0) = SCRIPT({
    DoBasicAI(N(aISettings_80243FC0));
});

s32 unk_missing_80244010[] = {
    0x00000000, 0x001E0018, 0x00000000, 0x00000000, N(script_80243FF0), 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00630010, 0x00000000, 0x00170013, 0x00000000, 0x00000000, N(script_80243FF0),
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00630010,
};

NpcAISettings N(aISettings_80244068) = {
    .moveSpeed = 1.5f,
    .moveTime = 0x3C,
    .waitTime = 0x1E,
    .alertRadius = 0.0f,
...
Script N(script_NpcAI_80244098) = SCRIPT({
    DoBasicAI(N(aISettings_80244068));
});

NpcSettings N(npcSettings_802440B8) = {
    .unk_00 = { 0, 0, 0, 0 },
    .height = 0x18,
    .radius = 0x18,
    .otherAI = NULL,
    .onInteract = NULL,
    .ai = &N(script_NpcAI_80244098),
    .onHit = NULL,
    .aux = NULL,
    .onDefeat = NULL,
    .flags = 0,
...
NpcAISettings N(aISettings_802440E4) = {
    .moveSpeed = 1.5f,
    .moveTime = 0x3C,
    .waitTime = 0x1E,
    .alertRadius = 0.0f,
...
Script N(script_NpcAI_80244114) = SCRIPT({
    DoBasicAI(N(aISettings_802440E4));
});

NpcSettings N(npcSettings_80244134) = {
    .unk_00 = { 0, 0, 0, 0 },
    .height = 0x18,
    .radius = 0x18,
    .otherAI = NULL,
    .onInteract = NULL,
    .ai = &N(script_NpcAI_80244114),
    .onHit = NULL,
    .aux = NULL,
    .onDefeat = NULL,
    .flags = 0,
...
NpcSettings N(npcSettings_80244160) = {
    .unk_00 = { 0, 0, 0, 0 },
    .height = 0x1E,
    .radius = 0x18,
    .otherAI = NULL,
...
Script N(script_NpcAI_80244200) = SCRIPT({
    SetSelfVar(0, 0);
    SetSelfVar(5, 0);
    SetSelfVar(6, 0);
    SetSelfVar(1, 200);
    func_8024185C_D216EC(N(aISettings_802441D0));
});

s32 unk_missing_80244270[] = {
    0x00000000, 0x001A0018, 0x00000000, 0x00000000, N(script_NpcAI_80244200), 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00630000,
};

NpcSettings N(npcSettings_8024429C) = {
    .unk_00 = { 0, 0, 0, 0 },
    .height = 0x14,
    .radius = 0x14,
    .otherAI = NULL,
    .onInteract = NULL,
    .ai = &N(script_NpcAI_80244200),
    .onHit = NULL,
    .aux = NULL,
    .onDefeat = NULL,
    .flags = 0,
...
s32 unk_missing_802442C8[] = {
    0x00000000, 0x00160018, 0x00000000, 0x00000000, N(script_NpcAI_80244200), 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00630000, 0x00000000, 0x001A0018, 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00630000,
};

NpcSettings N(npcSettings_80244320) = {
    .unk_00 = { 0, 0, 0, 0 },
    .height = 0x14,
    .radius = 0x14,
    .otherAI = NULL,
...
NpcSettings N(npcSettings_802443A4) = {
    .unk_00 = { 0, 0, 0, 0 },
    .height = 0x18,
    .radius = 0x18,
    .otherAI = NULL,
...
Script N(script_802443D4) = SCRIPT({
    ShowGotItem(SI_VAR(0), 1, 0);
    return;
});

Script N(script_80244404) = SCRIPT({
...
s32 N(unk_80244754)[] = {
    N(unk_80246068), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0x02EE0000, N(unk_80244A88), 0x00000000,
};

s32 N(unk_80244780)[] = {
    N(unk_80246068), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80244754), 0x00000000,
    0x02BC0000, N(unk_80244A88), 0x00000000,
};

s32 N(unk_802447AC)[] = {
    N(unk_80246068), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80244780), 0x00000000,
    0x028A0000, N(unk_80244A88), 0x00000000,
};

s32 N(unk_802447D8)[] = {
    N(unk_80246068), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_802447AC), 0x00000000,
    0x02580000, N(unk_80244A88), 0x00000000,
};

s32 N(unk_80244804)[] = {
    N(unk_80246068), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_802447D8), 0x00000000,
    0x02260000, N(unk_80244A88), 0x00000000,
};

s32 N(unk_80244830)[] = {
    N(unk_80246068), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80244804), 0x00000000,
    0x01F40000, N(unk_80244A88), 0x00000000,
};

s32 N(unk_8024485C)[] = {
    N(unk_80246068), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80244830), 0x00000000,
    0x01C20000, N(unk_80244A88), 0x00000000,
};

s32 N(unk_80244888)[] = {
    N(unk_80246068), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_8024485C), 0x00000000,
    0x01900000, N(unk_80244A88), 0x00000000,
};

s32 N(unk_802448B4)[] = {
    N(unk_80246068), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80244888), 0x00000000,
    0x015E0000, N(unk_80244A88), 0x00000000,
};

s32 N(unk_802448E0)[] = {
    N(unk_80246068), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_802448B4), 0x00000000,
    0x012C0000, N(unk_80244A88), 0x00000000,
};

s32 N(unk_8024490C)[] = {
    N(unk_80246068), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_802448E0), 0x00000000,
    0x00FA0000, N(unk_80244A88), 0x00000000,
};

s32 N(unk_80244938)[] = {
    N(unk_80246068), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_8024490C), 0x00000000,
    0x00C80000, N(unk_80244A88), 0x00000000,
};

s32 N(unk_80244964)[] = {
    N(unk_80246068), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80244938), 0x00000000,
    0x00960000, N(unk_80244A88), 0x00000000,
};

s32 N(unk_80244990)[] = {
    N(unk_80246068), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80244964), 0x00000000,
    0x00640000, N(unk_80244A88), 0x00000000,
};

s32 N(unk_802449BC)[] = {
    N(unk_80246068), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80244990), 0x00000000,
    0x00320000, N(unk_80244A88), 0x00000000,
};

s32 N(unk_802449E8)[] = {
    N(unk_80246068), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_802449BC), 0x00000000,
    0x00000000, N(unk_80244A88), 0x00000000,
};

s32 N(unk_80244A14)[] = {
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_802449E8),
    0xFFFF0000, 0x00000000, 0x00000000, N(unk_80244A14), N(unk_802449E8), N(unk_802449BC), N(unk_80244990), N(unk_80244964),
    N(unk_80244938), N(unk_8024490C), N(unk_802448E0), N(unk_802448B4), N(unk_80244888), N(unk_8024485C), N(unk_80244830), N(unk_80244804),
    N(unk_802447D8), N(unk_802447AC), N(unk_80244780), N(unk_80244754), 0x00000000,
};
...
s32 N(unk_80246068)[] = {
    0xD7000002, 0xFFFFFFFF, 0xE7000000, 0x00000000, 0xFC121824, 0xFF33FFFF, 0xFD100000, N(unk_802461D0),
    0xF5100000, 0x07094140, 0xE6000000, 0x00000000, 0xF3000000, 0x071FF200, 0xE7000000, 0x00000000,
    0xF5100800, 0x00094140, 0xF2000000, 0x0003C07C, 0xD9FFFFFF, 0x00020000, 0x01020040, N(unk_80244DA8),
    ...
    0x01012024, N(unk_80244DA8), 0x06000204, 0x00000406, 0x0602080A, 0x00020A04, 0x06080C0E, 0x00080E0A,
...
Script N(script_8024693C) = SCRIPT({
    SI_VAR(9) = SI_VAR(7);
    SI_VAR(8) = SI_VAR(6);
    SI_VAR(7) = SI_VAR(5);
    SI_VAR(6) = SI_VAR(4);
...
Script N(script_Interact_80246A94) = SCRIPT({
    func_80242164_D21FF4(0, 0, 0);
    await N(script_80249A50);
    if (SI_VAR(0) == 0) {
        return;
    }
    SI_VAR(9) = SI_VAR(1);
    ...
    func_80241F50_D21DE0();
    if (SI_VAR(4) != 0) {
        spawn N(script_8024693C);
    }
    func_802421E0_D22070(SI_VAR(10));
    sleep 20;
    ...
    sleep 105;
    await N(script_80249D1C);
    DisablePlayerPhysics(0);
    SetNpcFlagBits(-1, 256, 0);
    SpeakToPlayer(-1, 0x830004, 0x830001, 0, SI_VAR(11));
    func_80241F70_D21E00();
});

Script N(script_80246E3C) = SCRIPT({
    loop {
...
Script N(script_80247550) = SCRIPT({
    func_8024224C_D220DC(3, 0x9B0104, 0x9B0101, 81, 82, 0x1200FE, 0x1200FF, 0x120100, 0x120101, N(unk_80247548));
    await N(script_80247250);
});

Script N(script_Interact_802475A0) = SCRIPT({
    match SI_SAVE_VAR(0) {
        < 74 {
            SpeakToPlayer(0, 0xD20004, 0xD20001, 0, 0x1200F4);
        }
        < 89 {
            SpeakToPlayer(0, 0xD20004, 0xD20001, 0, 0x1200F5);
        }
        >= 89 {
            if (SI_SAVE_FLAG(1451) == 0) {
                SpeakToPlayer(0, 0xD20004, 0xD20001, 0, 0x1200F6);
                SI_SAVE_FLAG(1451) = 1;
            } else {
                SpeakToPlayer(0, 0xD20004, 0xD20001, 0, 0x1200F7);
            }
        }
    }
});

Script N(script_80247698) = SCRIPT({
0:
...
Script N(script_802477A8) = SCRIPT({
    SI_VAR(4) = 10;
    loop 10 {
        GetNpcPos(0, SI_VAR(0), SI_VAR(1), SI_VAR(2));
        SI_VAR(0) += 5;
...
Script N(script_802478D4) = SCRIPT({
    ...
    DisablePlayerInput(1);
    SetPlayerSpeed(3.0);
    PlayerMoveTo(0xFFFFFF10, 300, 0);
    PlayerFaceNpc(0, 0);
    SpeakToPlayer(0, 0xD20004, 0xD20001, 0, 0x1200E9);
    GetNpcPos(0, SI_VAR(0), SI_VAR(1), SI_VAR(2));
    ...
    PanToTarget(0, 0, 1);
    WaitForCam(0, 1.0);
    SpeakToPlayer(0, 0xD20004, 0xD20001, 0, 0x1200EA);
    UseSettingsFrom(0, 0xFFFFFF06, 0, 300);
    SetPanTarget(0, 0xFFFFFF06, 0, 300);
    SetCamDistance(0, 500.0);
    PanToTarget(0, 0, 1);
    WaitForCam(0, 1.0);
    SetNpcAnimation(0, 0xD20002);
    SetNpcSpeed(0, 3.0);
    NpcMoveTo(0, 0xFFFFFF92, 300, 0);
    SetNpcAnimation(0, 0xD20001);
    GetAngleToPlayer(0, SI_VAR(0));
    InterpNpcYaw(0, SI_VAR(0), 0);
    SpeakToPlayer(0, 0xD20004, 0xD20001, 0, 0x1200EB);
    PanToTarget(0, 0, 0);
    WaitForCam(0, 1.0);
    SI_AREA_FLAG(5) = 1;
    SI_SAVE_VAR(0) = 70;
    ...
    spawn {
        ...
        SetNpcAnimation(0, 0xD20002);
        SetNpcSpeed(0, 2.0);
        NpcMoveTo(0, 0xFFFFFFB2, 287, 0);
        SetNpcJumpscale(0, 0.5);
        NpcJump0(0, 0xFFFFFFE7, 20, 253, 17);
        SetNpcAnimation(0, 0xD20001);
        sleep 10;
        SetNpcAnimation(0, 0xD20002);
        NpcJump0(0, 0xFFFFFFD8, 45, 188, 17);
        SetNpcAnimation(0, 0xD20001);
        sleep 10;
        SetNpcAnimation(0, 0xD20002);
        NpcMoveTo(0, 0xFFFFFFA6, 190, 0);
        SetNpcAnimation(0, 0xD20001);
        SI_MAP_FLAG(0) = 1;
    }
});
...
60:
    ...
    PlayerFaceNpc(0, 0);
    SpeakToPlayer(0, 0xD20004, 0xD20001, 0, 0x1200EC);
    SI_SAVE_VAR(0) = 71;
    DisablePlayerInput(0);
    SI_MAP_FLAG(0) = 0;
    spawn {
        SetNpcAnimation(0, 0xD20002);
        NpcMoveTo(0, 0xFFFFFF92, 145, 0);
        NpcJump0(0, 0xFFFFFF7D, 60, 91, 20);
        SetNpcAnimation(0, 0xD20001);
        sleep 10;
        SetNpcAnimation(0, 0xD20002);
        NpcJump0(0, 0xFFFFFF8B, 90, 7, 20);
        SetNpcAnimation(0, 0xD20001);
        sleep 10;
        SetNpcAnimation(0, 0xD20002);
        NpcMoveTo(0, 0, 0xFFFFFF71, 0);
...
Script N(script_802480C4) = SCRIPT({
    ...
    SI_MAP_FLAG(0) = 0;
    SpeakToPlayer(0, 0xD20004, 0xD20001, 0, 0x1200ED);
    spawn {
        SetNpcAnimation(0, 0xD20002);
        SetNpcSpeed(0, 3.0);
        NpcMoveTo(0, 27, 0xFFFFFF88, 0);
    }
    SetPlayerSpeed(3.0);
    PlayerMoveTo(15, 0xFFFFFFA6, 0);
    SetGroupEnabled(93, 1);
    PlaySoundAtCollider(24, 449, 0);
    MakeLerp(0, 90, 10, 4);
70:
    UpdateLerp();
    RotateModel(75, SI_VAR(0), 0, -1, 0);
    ...
    spawn {
        SetNpcAnimation(0, 0xD20002);
        SetNpcSpeed(0, 4.0);
        NpcMoveTo(0, 0, 0xFFFFFEB6, 0);
        SetNpcAnimation(0, 0xD20001);
    }
    SetCamSpeed(0, 1.80078125);
    ModifyColliderFlags(0, 24, 0x7FFFFE00);
    ModifyColliderFlags(0, 25, 0x7FFFFE00);
    PlayerMoveTo(0, 0xFFFFFF38, 0);
    spawn {
        SI_VAR(0) = 0;
        SI_VAR(15) = 94;
        SetNpcFlagBits(0, 0x800000, 0);
        SetNpcFlagBits(10, 0x800000, 1);
        func_80242538_D223C8();
    }
    spawn {
        MakeLerp(0, 90, 10, 1);
    71:
        ...
        SI_VAR(2) = 90;
        SI_VAR(2) -= SI_VAR(0);
        RotateModel(75, SI_VAR(2), 0, -1, 0);
        sleep 1;
        if (SI_VAR(1) == 1) {
            goto 71;
        }
        SetGroupEnabled(71, 0);
        PlaySoundAtCollider(24, 450, 0);
    }
    PlayerMoveTo(0, 0xFFFFFF10, 0);
    ModifyColliderFlags(1, 24, 0x7FFFFE00);
    ModifyColliderFlags(1, 25, 0x7FFFFE00);
    SetCamSpeed(0, 1.0);
    sleep 30;
    GetAngleToPlayer(0, SI_VAR(0));
    InterpNpcYaw(0, SI_VAR(0), 0);
    SpeakToPlayer(0, 0xD20004, 0xD20001, 0, 0x1200EE);
    GetNpcPos(0, SI_VAR(0), SI_VAR(1), SI_VAR(2));
    UseSettingsFrom(0, SI_VAR(0), SI_VAR(1), SI_VAR(2));
    SetPanTarget(0, SI_VAR(0), SI_VAR(1), SI_VAR(2));
    SetCamDistance(0, 250.0);
    SetCamPosA(0, 200.7001953125, -321.0);
    SetCamPosB(0, 0.7001953125, -321.0);
    SetCamPitch(0, 21.0, -14.5);
    SetCamSpeed(0, 90.0);
    PanToTarget(0, 0, 1);
    WaitForCam(0, 1.0);
    sleep 5;
    SpeakToPlayer(0, 0xD20004, 0xD20001, 0, 0x1200EF);
    PanToTarget(0, 0, 0);
    SetCamSpeed(0, 90.0);
    WaitForCam(0, 1.0);
    SpeakToPlayer(0, 0xD20004, 0xD20001, 0, 0x1200F0);
    GetPlayerPos(SI_VAR(0), SI_VAR(1), SI_VAR(2));
    UseSettingsFrom(0, SI_VAR(0), SI_VAR(1), SI_VAR(2));
    SetPanTarget(0, SI_VAR(0), SI_VAR(1), SI_VAR(2));
    SetCamDistance(0, 275.0);
    SetCamPosA(0, 200.7001953125, -250.0);
    SetCamPosB(0, 0.7001953125, -250.0);
    SetCamPitch(0, 21.0, -14.0);
    SetCamSpeed(0, 2.0);
    PanToTarget(0, 0, 1);
    SetNpcSpeed(0, 2.0);
    SetNpcAnimation(0, 0xD20002);
    SI_VAR(10) = spawn N(script_80247698);
    NpcMoveTo(0, 0, 0xFFFFFEED, 0);
    kill SI_VAR(10);
    SI_VAR(10) = spawn N(script_802477A8);
    sleep 20;
    kill SI_VAR(10);
    ...
    await N(script_802443D4);
    AddKeyItem(50);
    SpeakToPlayer(0, 0xD20004, 0xD20001, 0, 0x1200F1);
    sleep 10;
    SetCamPosA(0, 200.7001953125, -321.0);
    SetCamPosB(0, 0.7001953125, -321.0);
    ...
    WaitForCam(0, 1.0);
    sleep 15;
    SpeakToPlayer(0, 0xD20004, 0xD20001, 0, 0x1200F2);
    GetPlayerPos(SI_VAR(0), SI_VAR(1), SI_VAR(2));
    UseSettingsFrom(0, SI_VAR(0), SI_VAR(1), SI_VAR(2));
    SetPanTarget(0, SI_VAR(0), SI_VAR(1), SI_VAR(2));
    SetCamSpeed(0, 2.0);
    ...
    WaitForCam(0, 1.0);
    PanToTarget(0, 0, 0);
    BindNpcInteract(0, N(script_Interact_802475A0));
    SetNpcFlagBits(0, 256, 0);
    DisablePlayerInput(0);
});

Script N(script_Idle_80248B98) = SCRIPT({
    sleep 3;
    if (SI_SAVE_VAR(0) < 70) {
        await N(script_802478D4);
        await N(script_80247D8C);
        await N(script_802480C4);
        return;
    }
    if (SI_SAVE_VAR(0) == 70) {
        SetNpcPos(0, 0xFFFFFFA6, 45, 190);
        InterpNpcYaw(0, 270, 0);
        SI_MAP_FLAG(0) = 1;
        await N(script_80247D8C);
        await N(script_802480C4);
...
Script N(script_80248CE4) = SCRIPT({
    spawn {
        DisablePartnerAI(0);
        SetNpcSpeed(0xFFFFFFFC, 3.0);
        NpcMoveTo(0xFFFFFFFC, 0xFFFFFFE4, 0xFFFFFFB0, 0);
        EnablePartnerAI();
    }
    SetPlayerSpeed(3.0);
    PlayerMoveTo(0, 0xFFFFFF9C, 0);
    SetGroupEnabled(93, 1);
    SetGroupEnabled(71, 1);
    SetNpcPos(0, 0, 90, 0xFFFFFF4C);
    PlaySoundAtCollider(24, 449, 0);
    MakeLerp(0, 90, 10, 1);
0:
    UpdateLerp();
...
1:
    ...
    PanToTarget(0, 0, 1);
    WaitForCam(0, 1.0);
    SpeakToPlayer(0, 0xD20004, 0xD20001, 0, 0x1200F3);
    SetGroupEnabled(93, 1);
    PlaySoundAtCollider(24, 449, 0);
    MakeLerp(0, 90, 10, 1);
2:
    ...
    SetNpcSpeed(0, 3.0);
    SetNpcAnimation(0, 0xD20002);
    NpcMoveTo(0, 0, 0xFFFFFF4C, 0);
    spawn {
        NpcMoveTo(0, 0, 0xFFFFFED4, 0);
        SetNpcAnimation(0, 0xD20001);
    }
    MakeLerp(90, 0, 10, 1);
3:
...
Script N(script_Interact_8024932C) = SCRIPT({
    match SI_SAVE_VAR(0) {
        < 87 {
            SpeakToPlayer(-1, 0x9B0004, 0x9B0001, 0, 0x1200F8);
        }
        >= 87 {
            SpeakToPlayer(-1, 0x9B0004, 0x9B0001, 0, 0x1200F9);
        }
    }
});

Script N(script_Interact_802493A8) = SCRIPT({
    match SI_SAVE_VAR(0) {
        < 87 {
            SpeakToPlayer(-1, 0x9B0204, 0x9B0201, 0, 0x1200FA);
        }
        >= 87 {
            SpeakToPlayer(-1, 0x9B0204, 0x9B0201, 0, 0x1200FB);
        }
    }
});

Script N(script_Interact_80249424) = SCRIPT({
    match SI_SAVE_VAR(0) {
        < 87 {
            SpeakToPlayer(-1, 0x9B0104, 0x9B0101, 0, 0x1200FC);
        }
        >= 87 {
            SpeakToPlayer(-1, 0x9B0104, 0x9B0101, 0, 0x1200FD);
        }
    }
    await N(script_80247550);
    if (SI_VAR(12) != 0) {
        return;
    }
});

Script N(script_Interact_802494CC) = SCRIPT({
    match SI_SAVE_VAR(0) {
        < 87 {
            SpeakToPlayer(-1, 0xCD0004, 0xCD0001, 0, 0x120102);
        }
        >= 87 {
            SpeakToPlayer(-1, 0xCD0004, 0xCD0001, 0, 0x120103);
        }
    }
});

Script N(script_Interact_80249548) = SCRIPT({
    match SI_SAVE_VAR(0) {
        < 87 {
            SpeakToPlayer(-1, 0xCD0004, 0xCD0001, 0, 0x120104);
        }
        >= 87 {
            SpeakToPlayer(-1, 0xCD0004, 0xCD0001, 0, 0x120105);
        }
    }
});

Script N(script_Interact_802495C4) = SCRIPT({
    match SI_SAVE_VAR(0) {
        < 87 {
            SpeakToPlayer(-1, 0xCD0004, 0xCD0001, 0, 0x120106);
        }
        >= 87 {
            SpeakToPlayer(-1, 0xCD0004, 0xCD0001, 0, 0x120107);
        }
    }
});

Script N(script_Interact_80249640) = SCRIPT({
    match SI_SAVE_VAR(0) {
        < 87 {
            SpeakToPlayer(-1, 0xCD0004, 0xCD0001, 0, 0x120114);
        }
        >= 87 {
            SpeakToPlayer(-1, 0xCD0004, 0xCD0001, 0, 0x120115);
        }
    }
});

Script N(script_Interact_802496BC) = SCRIPT({
    match SI_SAVE_VAR(0) {
        < 87 {
            SpeakToPlayer(-1, 0xB30002, 0xB30001, 0, 0x120108);
        }
        >= 87 {
            SpeakToPlayer(-1, 0xB30002, 0xB30001, 0, 0x120109);
        }
    }
});

Script N(script_Interact_80249738) = SCRIPT({
    match SI_SAVE_VAR(0) {
        < 87 {
            SpeakToPlayer(-1, 0xB30002, 0xB30001, 0, 0x12010A);
        }
        >= 87 {
            SpeakToPlayer(-1, 0xB30002, 0xB30001, 0, 0x12010B);
        }
    }
});

Script N(script_Interact_802497B4) = SCRIPT({
    if (SI_SAVE_FLAG(1453) == 0) {
        SI_SAVE_FLAG(1453) = 1;
        MakeLerp(90, 360, 20, 0);
        loop {
            UpdateLerp();
    ...
    match SI_SAVE_VAR(0) {
        < 87 {
            SpeakToPlayer(-1, 0xB30002, 0xB30001, 0, 0x12010C);
        }
        >= 87 {
            SpeakToPlayer(-1, 0xB30002, 0xB30001, 0, 0x12010D);
        }
    }
});

Script N(script_Interact_802498DC) = SCRIPT({
    match SI_SAVE_VAR(0) {
        < 87 {
            SpeakToPlayer(-1, 0xB30002, 0xB30001, 0, 0x12010E);
        }
        >= 87 {
            SpeakToPlayer(-1, 0xB30002, 0xB30001, 0, 0x12010F);
        }
    }
});

Script N(script_Interact_80249958) = SCRIPT({
    match SI_SAVE_VAR(0) {
        < 87 {
            SpeakToPlayer(-1, 0xB30002, 0xB30001, 0, 0x120110);
        }
        >= 87 {
            SpeakToPlayer(-1, 0xB30002, 0xB30001, 0, 0x120111);
        }
    }
});

Script N(script_Interact_802499D4) = SCRIPT({
    match SI_SAVE_VAR(0) {
        < 87 {
            SpeakToPlayer(-1, 0xB30002, 0xB30001, 0, 0x120112);
        }
        >= 87 {
            SpeakToPlayer(-1, 0xB30002, 0xB30001, 0, 0x120113);
        }
    }
});

Script N(script_80249A50) = SCRIPT({
    SI_VAR(0) = 0x120116;
    SI_VAR(8) = 0x120117;
    SI_VAR(1) = 0x120118;
    SI_VAR(2) = 0x120119;
...
Script N(script_80249AB0) = SCRIPT({
    spawn N(script_8024269C);
    SetPlayerSpeed(3.0);
    PlayerMoveTo(0xFFFFFEB0, 0xFFFFFFD0, 0);
    spawn {
        sleep 15;
        func_80242014_D21EA4(0, 40.0);
        SetCamType(0, 4, 0);
        SetCamPitch(0, 50.0, -16.0);
        SetCamDistance(0, 111.0);
        SetCamPosA(0, -92.0, 94.0);
        SetCamPosB(0, -318.099609375, -35.5);
        SetCamPosC(0, -641.0, 122.0);
        SetCamSpeed(0, 90.0);
        PanToTarget(0, 0, 1);
    }
...
Script N(script_Init_80249DAC) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_802475A0));
    BindNpcIdle(-1, N(script_Idle_80248B98));
    match SI_SAVE_VAR(0) {
        < 72 {
            SetNpcPos(-1, 0xFFFFFF38, 0, 300);
        }
        >= 72 {
            SetNpcPos(-1, 0, 90, 0xFFFFFED4);
            InterpNpcYaw(-1, 180, 0);
        }
    }
});

Script N(script_Init_80249E60) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_8024932C));
});

Script N(script_Init_80249E84) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_802493A8));
});

Script N(script_Init_80249EA8) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_80249424));
});

Script N(script_Init_80249ECC) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_802494CC));
});

Script N(script_Init_80249EF0) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_80249548));
});

Script N(script_Init_80249F14) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_802495C4));
});

Script N(script_Init_80249F38) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_80249640));
});

Script N(script_Init_80249F5C) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_802496BC));
});

Script N(script_Init_80249F80) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_80249738));
});

Script N(script_Init_80249FA4) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_802497B4));
    if (SI_SAVE_FLAG(1453) == 0) {
        SetNpcRotation(-1, 0, 90, 0);
    }
});

Script N(script_Init_80249FFC) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_802498DC));
});

Script N(script_Init_8024A020) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_80249958));
});

Script N(script_Init_8024A044) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_802499D4));
});

Script N(script_Init_8024A068) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_80246A94));
});

StaticNpc N(npcGroup_8024A08C)[] = {
    {
        .id = 0,
        .settings = &N(npcSettings_80244160),
        .pos = { 0.0, 90.0, -300.0 },
        .flags = 0x00400D09,
        .init = N(script_Init_80249DAC),
        .yaw = 0,
        .dropFlags = 0x80,
        .animations = {
            0x00D20001, 0x00D20001, 0x00D20001, 0x00D20001, 0x00D20001, 0x00D20001, 0x00D20001, 0x00D20001, 0x00D20001, 0x00D20001, 0x00D20001, 0x00D20001, 0x00D20001, 0x00D20001, 0x00D20001, 0x00D20001,
        },
        .tattle = 0x1A00FB,
    },
    {
        .id = 1,
        .settings = &N(npcSettings_802443A4),
        .pos = { -376.0, 60.0, 112.0 },
        .flags = 0x00402D09,
        .init = N(script_Init_80249E60),
        .yaw = 0,
        .dropFlags = 0x80,
        .animations = {
    ...
    {
        .id = 2,
        .settings = &N(npcSettings_80244134),
        .pos = { 208.0, 80.0, 150.0 },
        .flags = 0x00402D09,
        .init = N(script_Init_80249E84),
        .yaw = 180,
        .dropFlags = 0x80,
        .movement = { 0x000000D0, 0x00000050, 0x00000096, 0x00000032, 0x00000000, 0xFFFF8001, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000001 },
        .animations = {
            0x009B0201, 0x009B0202, 0x009B0201, 0x009B0201, 0x009B0201, 0x009B0201, 0x009B0201, 0x009B0201, 0x009B0201, 0x009B0201, 0x009B0201, 0x009B0201, 0x009B0201, 0x009B0201, 0x009B0201, 0x009B0201,
        },
        .tattle = 0x1A00FD,
    },
    {
        ...
        .pos = { 127.0, 0.0, 445.0 },
        .flags = 0x00402D09,
        .init = N(script_Init_80249EA8),
        .yaw = 180,
        .dropFlags = 0x80,
        .animations = {
            0x009B0101, 0x009B0102, 0x009B0101, 0x009B0101, 0x009B0101, 0x009B0101, 0x009B0101, 0x009B0101, 0x009B0101, 0x009B0101, 0x009B0101, 0x009B0101, 0x009B0101, 0x009B0101, 0x009B0101, 0x009B0101,
        },
        .tattle = 0x1A00FE,
    },
    {
        .id = 4,
        .settings = &N(npcSettings_802440B8),
        .pos = { -99.0, 90.0, -90.0 },
        .flags = 0x00402D09,
        .init = N(script_Init_80249ECC),
        .yaw = 0,
        .dropFlags = 0x80,
        .movement = { 0xFFFFFF9D, 0x0000005A, 0xFFFFFFA6, 0x0000001E, 0x00000000, 0xFFFF8001, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000001 },
        .animations = {
    ...
    },
    {
        ...
        .pos = { -48.0, 0.0, 400.0 },
        .flags = 0x00402D09,
        .init = N(script_Init_80249EF0),
        .yaw = 180,
        .dropFlags = 0x80,
        .movement = { 0xFFFFFFD0, 0x00000000, 0x00000190, 0x0000001E, 0x00000000, 0xFFFF8001, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000001 },
        .animations = {
            0x00CD0001, 0x00CD0002, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001,
        },
        .tattle = 0x1A0100,
    ...
    {
        .id = 6,
        .settings = &N(npcSettings_80244378),
        .pos = { 239.0, 50.0, 315.0 },
        .flags = 0x00402D09,
        .init = N(script_Init_80249F14),
        .yaw = 180,
        .dropFlags = 0x80,
        .animations = {
            0x00CD0001, 0x00CD0002, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001, 0x00CD0001,
    ...
    {
        .id = 8,
        .settings = &N(npcSettings_8024429C),
        .pos = { -166.0, 10.0, 390.0 },
        .flags = 0x00400D09,
        .init = N(script_Init_80249F5C),
        .yaw = 180,
        .dropFlags = 0x80,
        .movement = { 0xFFFFFF5A, 0x0000000A, 0x00000186, 0x00000032, 0x00000000, 0xFFFF8001, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000001 },
        .animations = {
    ...
    {
        .id = 9,
        .settings = &N(npcSettings_80244320),
        .pos = { 3.0, 60.0, 137.0 },
        .flags = 0x00400D09,
        .init = N(script_Init_80249F80),
        .yaw = 180,
        .dropFlags = 0x80,
        .animations = {
            0x00200001, 0x00200005, 0x00200008, 0x00200008, 0x00200001, 0x00200001, 0x00200001, 0x00200001, 0x00200001, 0x00200001, 0x00200001, 0x00200001, 0x00200001, 0x00200001, 0x00200001, 0x00200001,
    ...
    },
    {
        .id = 10,
        .settings = &N(npcSettings_80244320),
        .pos = { 120.0, 100.0, -210.0 },
        .flags = 0x00400D09,
        .init = N(script_Init_80249FA4),
        .yaw = 0,
        .dropFlags = 0x80,
        .animations = {
            0x00200001, 0x00200005, 0x00200008, 0x00200008, 0x00200001, 0x00200001, 0x00200001, 0x00200001, 0x00200001, 0x00200001, 0x00200001, 0x00200001, 0x00200001, 0x00200001, 0x00200001, 0x00200001,
...
NpcGroupList N(npcGroupList_8024BD9C) = {
    NPC_GROUP(N(npcGroup_8024A08C), 0x00000001),
    {},
};
...
// rodata: D_8024BE30_D2BCC0

s32 pad_00BE38[] = {
    0x00000000, 0x00000000,
};

// rodata: D_8024BE40_D2BCD0

// rodata: D_8024BE48_D2BCD8

// rodata: D_8024BE50_D2BCE0

// rodata: jtbl_8024BE58_D2BCE8
