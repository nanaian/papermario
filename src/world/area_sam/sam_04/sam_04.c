...
Vec4f N(triggerCoord_80241620) =  { -411.0f, 0.0f, 163.0f, 0.0f };
...
Vec4f N(triggerCoord_80241670) =  { 426.0f, 0.0f, -105.0f, 0.0f };
...
Vec4f N(triggerCoord_802416A4) =  { 315.0f, 0.0f, -115.0f, 0.0f };
...
Vec4f N(triggerCoord_802416D8) =  { 314.0f, 0.0f, -114.0f, 0.0f };
...
Vec4f N(triggerCoord_8024170C) =  { -294.0f, 0.0f, -213.0f, 0.0f };
...
Script N(script_802439C8) = {
    ...
    SI_CMD(ScriptOpcode_BIND_TRIGGER, N(script_80243884), 0x10, 0, N(script_Idle_80245210), 0, 1),
...
Script N(script_80243B4C) = {
    ...
    SI_CMD(ScriptOpcode_BIND_TRIGGER, N(script_80243A18), 0x10, 0, N(script_Idle_802453D8), 0, 1),
    SI_CMD(ScriptOpcode_CALL, func_8024053C_D13B0C, SI_VAR(0)),
    SI_CMD(ScriptOpcode_RETURN),
    SI_CMD(ScriptOpcode_END)
};
...
Script N(script_MakeEntities) = SCRIPT({
    MakeEntity(D_802EAB04, 40, 0, 400, 0, 15, 0x80000000);
