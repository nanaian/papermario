...
s32 pad_00002C[1];
s32 unk_missing_80240A50[8];
s32 pad_000CAC[1];
s32 unk_missing_8024231C[19];
s32 unk_missing_8024249C[72];
s32 pad_003538[2];
Script N(script_80243630);
Script N(script_8024365C);
s32 pad_003688[2];
Script N(script_ExitWalk_80243690);
Script N(script_ExitWalk_802436EC);
Script N(script_80243748);
Script N(script_80243790);
Script N(main);
s32 pad_003B2C[1];
Script N(script_UpdateTexturePan_80243B30);
s32 N(byteTable_80243BCC)[1];
s32 N(byteTable_80243BD0)[2];
Script N(script_80243BD8);
s32 pad_0042BC[1];
Script N(script_OpenDoor_802442C0);
Script N(script_MoveWalls_802442F0);
Script N(script_DropDoor_802443C0);
Script N(script_OpenDoor_802443F0);
Script N(script_MoveWalls_80244420);
s32 N(npcList_802444F0)[2];
Script N(script_OpenDoor_802444F8);
Script N(script_MoveWalls_80244528);
s32 N(npcList_80244648)[2];
Script N(script_80244650);
Script N(script_SearchBush_802446F0);
Script N(script_ShakeTree_80244A50);
Script N(script_ShakeTree_80245054);
Script N(script_802456C4);
s32 unk_missing_80245764[25];
f32 N(floatTable_802457F4)[6];
Script N(script_NpcAI_8024583C);
s32 unk_missing_802458AC[22];
s32 N(unk_80245930)[11];
s32 N(unk_8024595C)[11];
s32 N(unk_80245988)[11];
s32 N(unk_802459B4)[11];
s32 N(unk_802459E0)[11];
s32 N(unk_80245A0C)[11];
s32 N(unk_80245A38)[11];
s32 N(unk_80245A64)[11];
s32 N(unk_80245A90)[11];
s32 N(unk_80245ABC)[11];
s32 N(unk_80245AE8)[11];
s32 N(unk_80245B14)[11];
s32 N(unk_80245B40)[11];
s32 N(unk_80245B6C)[11];
s32 N(unk_80245B98)[11];
s32 N(unk_80245BC4)[11];
s32 N(unk_80245BF0)[30];
s32 N(unk_80245C68)[200];
s32 N(unk_80245F88)[1200];
s32 N(unk_80247248)[90];
s32 N(unk_802473B0)[445];
Script N(script_80247AA4);
Script N(script_80247B1C);
Script N(script_Interact_80247C74);
s32 pad_00801C[1];
Script N(script_80248020);
Script N(script_80248050);
s32 N(quizAnswers)[16];
s32 N(quizRequirements)[20];
Script N(script_80248110);
Script N(script_802481C0);
Script N(script_8024835C);
Script N(script_80248458);
Script N(script_80248494);
Script N(script_80248644);
Script N(script_8024877C);
Script N(script_802488E8);
Script N(script_8024891C);
Script N(script_8024895C);
Script N(script_80248998);
Script N(script_802494E0);
Script N(script_80249520);
Script N(script_802495FC);
Script N(script_802496AC);
Script N(script_8024975C);
Script N(script_8024A48C);
Script N(script_8024A500);
Script N(script_8024A580);
Script N(script_8024A5CC);
s32 unk_missing_8024A618[11];
Script N(script_Interact_8024A644);
Script N(script_Init_8024A674);
Script N(script_Interact_8024A698);
Script N(script_Init_8024A6C8);
Script N(script_Interact_8024A6EC);
Script N(script_Init_8024A71C);
Script N(script_Interact_8024A740);
Script N(script_Init_8024A770);
Script N(script_Interact_8024A794);
Script N(script_Init_8024A7C4);
Script N(script_8024A7E8);
Script N(script_8024AA1C);
Script N(script_8024AAA0);
Script N(script_Init_8024AB00);
Script N(script_Interact_8024AB24);
Script N(script_Init_8024AB40);
StaticNpc N(npcGroup_8024AB64)[8];
NpcGroupList N(npcGroupList_8024BAE4);
s32 pad_00BAFC[1];
s32 N(intTable_8024BB00)[23];
s32 N(shopInventory_8024BB5C)[21];
s32 N(shopPriceList_8024BBB0)[33];
Script N(script_8024BC34);
s32 N(shopItemPositions_8024BC88)[6];
s32 N(shopOwnerNPC_8024BCA0)[7];
Script N(script_8024BCBC);
s32 pad_00BCF8[2];
Script N(script_MakeEntities);
s32 pad_00BD44[3];
const char D_8024BD50_A26E50[8]; // "hos_02"
const char D_8024BD58_A26E58[8]; // "hos_04"
s32 pad_00BD68[2];
s32 pad_00BDC4[3];

// text: func_80240000_A1B100

s32 pad_00002C[] = {
    0x00000000,
};

// text: func_80240030_A1B130

// text: func_80240154_A1B254

// text: func_8024033C_A1B43C

// text: func_8024060C_A1B70C

// text: func_802407E8_A1B8E8

// text: func_80240928_A1BA28

s32 unk_missing_80240A50[] = {
    0x3C028007, 0x8C42419C, 0x8442008E, 0xAC820084, 0x03E00008, 0x24020002, 0x00000000, 0x00000000,
};

// text: func_80240A70_A1BB70

// text: func_80240AE0_A1BBE0

s32 pad_000CAC[] = {
    0x00000000,
};

// text: func_80240CB0_A1BDB0

// text: func_80240E60_A1BF60

// text: N(UnkNpcAIFunc1)

// text: func_80241548_A1C648

// text: N(UnkNpcAIFunc2)

// text: func_80241904_A1CA04

// text: func_80241970_A1CA70

// text: N(UnkNpcAIFunc3)

// text: func_80241B08_A1CC08

// text: func_80241E98_A1CF98

// text: func_80241FBC_A1D0BC

// text: func_802421A8_A1D2A8

// text: func_802421C8_A1D2C8

// text: func_802421F0_A1D2F0

// text: func_8024226C_A1D36C

// text: func_802422EC_A1D3EC

s32 unk_missing_8024231C[] = {
...
// text: func_80242368_A1D468

// text: func_802423BC_A1D4BC

// text: func_80242438_A1D538

// text: func_8024246C_A1D56C

s32 unk_missing_8024249C[] = {
    0x03E00008, 0x24020002, 0x27BDFFE0, 0xAFB00010, 0x3C108025, 0x2610801C, 0xAFBF0018, 0xAFB10014,
    ...
    0x08090950, 0x00000000, 0x0000182D, 0x0040282D, 0x0220202D, 0x8CA20000, 0x24A50004, 0x24630001,
    0xAC820084, 0x28620010, 0x1440FFFA, 0x24840004, 0x3C108025, 0x2610801C, 0x0C00AB4B, 0x8E040000,
...
// text: func_802425BC_A1D6BC

// text: func_802425D0_A1D6D0

// text: func_802425E0_A1D6E0

// text: func_80242804_A1D904

// text: func_80242850_A1D950

// text: func_80242870_A1D970

// text: func_802428D0_A1D9D0

// text: func_80242A1C_A1DB1C

// text: func_80242B90_A1DC90

// text: func_80242C14_A1DD14

// text: func_80242E2C_A1DF2C

// text: func_80242EE0_A1DFE0

// text: func_80242F14_A1E014

// text: func_80242F94_A1E094

// text: func_80242FAC_A1E0AC

// text: func_80242FC8_A1E0C8

// text: func_80242FE0_A1E0E0

// text: func_80243010_A1E110

// text: func_80243084_A1E184

// text: func_80243124_A1E224

// text: func_802432C0_A1E3C0

// text: func_80243324_A1E424

// text: func_802433B4_A1E4B4

// text: func_8024349C_A1E59C

// text: func_80243508_A1E608
...
Script N(script_ExitWalk_80243690) = SCRIPT({
    group 27;
    UseExitHeading(60, 0);
    spawn ExitWalk;
    GotoMap(D_8024BD50_A26E50, 1);
    sleep 100;
});

Script N(script_ExitWalk_802436EC) = SCRIPT({
    group 27;
    UseExitHeading(60, 1);
    spawn ExitWalk;
    GotoMap(D_8024BD58_A26E58, 0);
    sleep 100;
});

Script N(script_80243748) = SCRIPT({
    bind N(script_ExitWalk_80243690) to 0x80000 0;
    bind N(script_ExitWalk_802436EC) to 0x80000 4;
});

Script N(script_80243790) = SCRIPT({
0:
    func_80240000_A1B100(SI_VAR(0));
    match SI_VAR(0) {
        == 12 {
            goto 10;
        }
...
Script N(main) = SCRIPT({
    ...
    if (SI_VAR(1) == 1) {
        ...
        spawn N(script_80243748);
    } else {
        SI_VAR(0) = N(script_80243748);
        spawn EnterWalk;
        sleep 1;
    }
    spawn N(script_80243BD8);
    func_802D6340(6);
    spawn N(script_80243630);
    PlaySound(0x80000063);
    spawn N(script_80244650);
    spawn N(script_8024BCBC);
    spawn N(script_802456C4);
...
Script N(script_UpdateTexturePan_80243B30) = SCRIPT({
    group 0;
    if (SI_VAR(5) == 1) {
        if (SI_VAR(6) == 1) {
            if (SI_VAR(7) == 1) {
                if (SI_VAR(8) == 1) {
                    func_80240030_A1B130();
                    return;
                }
            }
        }
    }
    func_80240154_A1B254();
});

s32 N(byteTable_80243BCC)[] = {
    0x00000000,
};

s32 N(byteTable_80243BD0)[] = {
    0x00000000, 0x00000000,
};

Script N(script_80243BD8) = SCRIPT({
    spawn {
        SI_VAR(0) = 1;
        SI_VAR(1) = 100;
        SI_VAR(2) = 0xFFFFFFB0;
        ...
        SI_VAR(11) = 0;
        SI_VAR(12) = 0;
        spawn N(script_UpdateTexturePan_80243B30);
    }
    SetTexPanner(194, 1);
    SetTexPanner(185, 1);
    spawn {
    ...
    SetTexPanner(110, 7);
    func_802C9C70(0, 0, 1);
    func_802C94A0(1, func_802407E8_A1B8E8, 0);
    func_802C90FC(0, 1, -1);
});
...
Script N(script_OpenDoor_802442C0) = SCRIPT({
    RotateGroup(123, SI_VAR(0), 0, 1, 0);
});

Script N(script_MoveWalls_802442F0) = SCRIPT({
    SI_VAR(1) = SI_VAR(0);
    SI_VAR(1) *= -1.0;
...
Script N(script_DropDoor_802443C0) = SCRIPT({
...
Script N(script_MoveWalls_80244420) = SCRIPT({
    SI_VAR(1) = SI_VAR(0);
    SI_VAR(1) *= -1.0;
...
Script N(script_OpenDoor_802444F8) = SCRIPT({
    RotateGroup(55, SI_VAR(0), 0, 1, 0);
});

Script N(script_MoveWalls_80244528) = SCRIPT({
    SI_VAR(1) = SI_VAR(0);
    SI_VAR(1) *= -1.0;
...
Script N(script_80244650) = SCRIPT({
    MakeDoorAdvanced(0, N(script_OpenDoor_802442C0), N(script_MoveWalls_802442F0), N(script_DropDoor_802443C0), 0, 52, 53, 0, 0);
    MakeDoorAdvanced(0, N(script_OpenDoor_802443F0), N(script_MoveWalls_80244420), 0, 0, 40, 41, 0, N(npcList_802444F0));
    MakeDoorAdvanced(0, N(script_OpenDoor_802444F8), N(script_MoveWalls_80244528), 0, 0, 31, 32, 0, N(npcList_80244648));
});
        ...
        SI_CMD(ScriptOpcode_IF_NE, SI_VAR(1), 0),
            SI_CMD(ScriptOpcode_LOOP, 5),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(2)),
                    ...
                    SI_CMD(ScriptOpcode_CALL, func_80240AE0_A1BBE0, SI_VAR(3), SI_FIXED(0.1005859375), 1, SI_VAR(15), 0),
    ...
    SI_CMD(ScriptOpcode_SPAWN_THREAD),
        ...
        SI_CMD(ScriptOpcode_IF_NE, SI_VAR(1), 0),
            ...
            SI_CMD(ScriptOpcode_LOOP, 5),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(2)),
                    SI_CMD(ScriptOpcode_BUFFER_READ_1, SI_VAR(3)),
                    SI_CMD(ScriptOpcode_CALL, func_80240AE0_A1BBE0, SI_VAR(3), SI_FIXED(0.1005859375), SI_FIXED(0.2001953125), SI_VAR(15), 0),
                    SI_CMD(ScriptOpcode_IF_EQ, SI_FLAG(0), 0),
                        SI_CMD(ScriptOpcode_SET, SI_FLAG(0), 1),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(2)),
                    SI_CMD(ScriptOpcode_BUFFER_READ_1, SI_VAR(3)),
                    SI_CMD(ScriptOpcode_CALL, func_80240AE0_A1BBE0, SI_VAR(3), SI_FIXED(0.1005859375), SI_FIXED(-0.19921875), SI_VAR(15), 0),
                SI_CMD(ScriptOpcode_END_LOOP),
                SI_CMD(ScriptOpcode_SLEEP_FRAMES, 1),
            SI_CMD(ScriptOpcode_END_LOOP),
            SI_CMD(ScriptOpcode_USE_BUFFER, SI_VAR(1)),
    ...
    SI_CMD(ScriptOpcode_SPAWN_THREAD),
        ...
        SI_CMD(ScriptOpcode_IF_NE, SI_VAR(2), 0),
            SI_CMD(ScriptOpcode_LOOP, 5),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(3)),
                    SI_CMD(ScriptOpcode_BUFFER_READ_1, SI_VAR(4)),
                    SI_CMD(ScriptOpcode_CALL, func_80240AE0_A1BBE0, SI_VAR(4), SI_FIXED(0.1005859375), SI_FIXED(0.2001953125), SI_VAR(15), 0),
                    SI_CMD(ScriptOpcode_IF_EQ, SI_FLAG(0), 0),
                        SI_CMD(ScriptOpcode_SET, SI_FLAG(0), 1),
                ...
                SI_CMD(ScriptOpcode_LOOP, SI_VAR(3)),
                    SI_CMD(ScriptOpcode_BUFFER_READ_1, SI_VAR(4)),
                    SI_CMD(ScriptOpcode_CALL, func_80240AE0_A1BBE0, SI_VAR(4), SI_FIXED(0.1005859375), SI_FIXED(-0.19921875), SI_VAR(15), 0),
                SI_CMD(ScriptOpcode_END_LOOP),
                SI_CMD(ScriptOpcode_SLEEP_FRAMES, 1),
            SI_CMD(ScriptOpcode_END_LOOP),
            SI_CMD(ScriptOpcode_USE_BUFFER, SI_VAR(2)),
...
ModelIdList N(treeModelList_Tree1_Leaves) = {
    .count = 0x3,
    .modelIDs = { 0x97, 0x98, 0x99 },
};

ModelIdList N(treeModelList_Tree1_Trunk) = {
    .count = 0x3,
    .modelIDs = { 0x94, 0x95, 0x96 },
};
...
ModelIdList N(treeModelList_Tree2_Leaves) = {
    .count = 0x3,
    .modelIDs = { 0x9F, 0xA0, 0xA1 },
};

ModelIdList N(treeModelList_Tree2_Trunk) = {
    .count = 0x3,
    .modelIDs = { 0x9C, 0x9D, 0x9E },
};
...
Script N(script_802456C4) = SCRIPT({
    ...
    bind N(script_ShakeTree_80245054) to TriggerFlag_WALL_HAMMER 59;
    bind N(script_ShakeTree_80245054) to TriggerFlag_BOMB N(triggerCoord_80245654);
    SI_VAR(0) = N(shakeTreeEvent_Tree2);
    bind N(script_ShakeTree_80245054) to TriggerFlag_WALL_HAMMER 60;
    bind N(script_ShakeTree_80245054) to TriggerFlag_BOMB N(triggerCoord_802456B4);
});

s32 unk_missing_80245764[] = {
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x001A0018, 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00630000, 0x00000000, 0x00140014,
...
Script N(script_NpcAI_8024583C) = SCRIPT({
    SetSelfVar(0, 0);
    SetSelfVar(5, 0);
    SetSelfVar(6, 0);
    SetSelfVar(1, 200);
    func_80241FBC_A1D0BC(N(aISettings_8024580C));
});

s32 unk_missing_802458AC[] = {
    0x00000000, 0x001A0018, 0x00000000, 0x00000000, N(script_NpcAI_8024583C), 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00630000, 0x00000000, 0x00140014, 0x00000000, 0x00000000, N(script_NpcAI_8024583C),
...
s32 N(unk_80245930)[] = {
    N(unk_80247248), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0x02EE0000, N(unk_80245C68), 0x00000000,
};

s32 N(unk_8024595C)[] = {
    N(unk_80247248), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80245930), 0x00000000,
    0x02BC0000, N(unk_80245C68), 0x00000000,
};

s32 N(unk_80245988)[] = {
    N(unk_80247248), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_8024595C), 0x00000000,
    0x028A0000, N(unk_80245C68), 0x00000000,
};

s32 N(unk_802459B4)[] = {
    N(unk_80247248), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80245988), 0x00000000,
    0x02580000, N(unk_80245C68), 0x00000000,
};

s32 N(unk_802459E0)[] = {
    N(unk_80247248), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_802459B4), 0x00000000,
    0x02260000, N(unk_80245C68), 0x00000000,
};

s32 N(unk_80245A0C)[] = {
    N(unk_80247248), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_802459E0), 0x00000000,
    0x01F40000, N(unk_80245C68), 0x00000000,
};

s32 N(unk_80245A38)[] = {
    N(unk_80247248), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80245A0C), 0x00000000,
    0x01C20000, N(unk_80245C68), 0x00000000,
};

s32 N(unk_80245A64)[] = {
    N(unk_80247248), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80245A38), 0x00000000,
    0x01900000, N(unk_80245C68), 0x00000000,
};

s32 N(unk_80245A90)[] = {
    N(unk_80247248), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80245A64), 0x00000000,
    0x015E0000, N(unk_80245C68), 0x00000000,
};

s32 N(unk_80245ABC)[] = {
    N(unk_80247248), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80245A90), 0x00000000,
    0x012C0000, N(unk_80245C68), 0x00000000,
};

s32 N(unk_80245AE8)[] = {
    N(unk_80247248), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80245ABC), 0x00000000,
    0x00FA0000, N(unk_80245C68), 0x00000000,
};

s32 N(unk_80245B14)[] = {
    N(unk_80247248), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80245AE8), 0x00000000,
    0x00C80000, N(unk_80245C68), 0x00000000,
};

s32 N(unk_80245B40)[] = {
    N(unk_80247248), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80245B14), 0x00000000,
    0x00960000, N(unk_80245C68), 0x00000000,
};

s32 N(unk_80245B6C)[] = {
    N(unk_80247248), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80245B40), 0x00000000,
    0x00640000, N(unk_80245C68), 0x00000000,
};

s32 N(unk_80245B98)[] = {
    N(unk_80247248), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80245B6C), 0x00000000,
    0x00320000, N(unk_80245C68), 0x00000000,
};

s32 N(unk_80245BC4)[] = {
    N(unk_80247248), 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80245B98), 0x00000000,
    0x00000000, N(unk_80245C68), 0x00000000,
};

s32 N(unk_80245BF0)[] = {
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, N(unk_80245BC4),
    0xFFFF0000, 0x00000000, 0x00000000, N(unk_80245BF0), N(unk_80245BC4), N(unk_80245B98), N(unk_80245B6C), N(unk_80245B40),
    N(unk_80245B14), N(unk_80245AE8), N(unk_80245ABC), N(unk_80245A90), N(unk_80245A64), N(unk_80245A38), N(unk_80245A0C), N(unk_802459E0),
    N(unk_802459B4), N(unk_80245988), N(unk_8024595C), N(unk_80245930), 0x00000000, 0x00000000,
};
...
s32 N(unk_80247248)[] = {
    0xD7000002, 0xFFFFFFFF, 0xE7000000, 0x00000000, 0xFC121824, 0xFF33FFFF, 0xFD100000, N(unk_802473B0),
    0xF5100000, 0x07094140, 0xE6000000, 0x00000000, 0xF3000000, 0x071FF200, 0xE7000000, 0x00000000,
    0xF5100800, 0x00094140, 0xF2000000, 0x0003C07C, 0xD9FFFFFF, 0x00020000, 0x01020040, N(unk_80245F88),
    ...
    0x01012024, N(unk_80245F88), 0x06000204, 0x00000406, 0x0602080A, 0x00020A04, 0x06080C0E, 0x00080E0A,
...
Script N(script_80247B1C) = SCRIPT({
    SI_VAR(9) = SI_VAR(7);
    SI_VAR(8) = SI_VAR(6);
    SI_VAR(7) = SI_VAR(5);
    SI_VAR(6) = SI_VAR(4);
...
Script N(script_Interact_80247C74) = SCRIPT({
    func_802423BC_A1D4BC(0, 0, 0);
    await N(script_8024AAA0);
    if (SI_VAR(0) == 0) {
        return;
    }
    SI_VAR(9) = SI_VAR(1);
    SI_VAR(10) = SI_VAR(2);
    SI_VAR(11) = SI_VAR(3);
    func_80242368_A1D468();
    if (SI_VAR(1) == 0) {
        SI_VAR(8) = SI_VAR(0);
    }
    SpeakToPlayer(-1, 0xB30002, 0xB30001, 0, SI_VAR(8));
    ShowChoice(0x1E0006);
    sleep 3;
    if (SI_VAR(0) == 1) {
        ContinueSpeech(-1, 0xB30002, 0xB30001, 0, SI_VAR(9));
        return;
    }
    ContinueSpeech(-1, 0xB30002, 0xB30001, 0, SI_VAR(10));
    SetPlayerJumpscale(1);
    DisablePlayerPhysics(1);
    SetNpcFlagBits(-1, 256, 1);
    func_802421A8_A1D2A8();
    if (SI_VAR(4) != 0) {
        spawn N(script_80247B1C);
    }
    func_80242438_A1D538(SI_VAR(10));
    sleep 20;
    await N(script_8024A7E8);
    spawn {
        MakeLerp(0, 255, 60, 0);
    0:
        UpdateLerp();
        func_802421F0_A1D2F0(3, SI_VAR(0));
        sleep 1;
        if (SI_VAR(1) == 1) {
            goto 0;
        }
        ...
        FullyRestoreSP();
        if (SI_VAR(4) != 0) {
            spawn N(script_80247AA4);
        }
        func_8024246C_A1D56C(SI_VAR(10));
        sleep 45;
        MakeLerp(255, 0, 30, 0);
    1:
        UpdateLerp();
        func_802421F0_A1D2F0(0, SI_VAR(0));
        sleep 1;
        if (SI_VAR(1) == 1) {
            goto 1;
        }
    ...
    sleep 105;
    await N(script_8024AA1C);
    DisablePlayerPhysics(0);
    SetNpcFlagBits(-1, 256, 0);
    SpeakToPlayer(-1, 0xB30002, 0xB30001, 0, SI_VAR(11));
    func_802421C8_A1D2C8();
});
...
Script N(script_80248020) = SCRIPT({
    ShowGotItem(SI_VAR(0), 1, 0);
    return;
});

Script N(script_80248050) = SCRIPT({
...
Script N(script_80248110) = SCRIPT({
...
Script N(script_802481C0) = SCRIPT({
    func_80243084_A1E184(0, SI_ARRAY(0));
    func_80243010_A1E110(0, 25);
...
Script N(script_8024835C) = SCRIPT({
...
Script N(script_80248458) = SCRIPT({
    func_80243010_A1E110(0, SI_ARRAY(0));
    PanToTarget(0, 0, 0);
});

Script N(script_80248494) = SCRIPT({
    sleep 20;
    func_80243124_A1E224(SI_ARRAY(1), SI_ARRAY(3), 83, SI_VAR(0), SI_VAR(1));
    spawn {
        SI_VAR(2) = 0;
        loop 60 {
            SI_VAR(3) =f SI_VAR(0);
    ...
    func_802432C0_A1E3C0();
    func_802D2884(SI_ARRAY(1), SI_ARRAY(3), 0);
    SetPlayerAnimation(0x10002);
});

Script N(script_80248644) = SCRIPT({
    GetNpcPos(0xFFFFFFFC, SI_VAR(10), SI_VAR(11), SI_VAR(12));
    func_80243124_A1E224(SI_VAR(10), SI_VAR(12), 108, SI_VAR(0), SI_VAR(1));
    SI_VAR(5) =f SI_ARRAY(2);
    SI_VAR(5) -=f SI_VAR(11);
    spawn {
        func_802433B4_A1E4B4();
        SI_VAR(3) =f SI_VAR(0);
        SI_VAR(4) =f SI_VAR(1);
        SI_VAR(6) =f SI_VAR(5);
    ...
    func_80243324_A1E424();
    NpcFacePlayer(0xFFFFFFFC, 0);
    SetNpcAnimation(0xFFFFFFFC, 262);
});

Script N(script_8024877C) = SCRIPT({
    GetNpcPos(7, SI_VAR(10), SI_VAR(11), SI_VAR(12));
    func_80243124_A1E224(SI_VAR(10), SI_VAR(12), 0xFFFFFFBA, SI_VAR(0), SI_VAR(1));
    spawn {
        SI_VAR(2) = 0;
        loop 60 {
            SI_VAR(3) =f SI_VAR(0);
            ...
            SI_VAR(3) +=f SI_VAR(10);
            SI_VAR(4) +=f SI_VAR(12);
            SetNpcPos(7, SI_VAR(3), SI_ARRAY(2), SI_VAR(4));
            SI_VAR(2) += 1;
            sleep 1;
        }
    }
    sleep 60;
    NpcFacePlayer(7, 0);
    SetNpcAnimation(7, 0xAF0001);
});

Script N(script_802488E8) = SCRIPT({
    spawn N(script_80248494);
    spawn N(script_80248644);
    await N(script_8024877C);
});
...
Script N(script_8024895C) = SCRIPT({
...
Script N(script_802494E0) = SCRIPT({
...
Script N(script_80249520) = SCRIPT({
    spawn {
        func_80243124_A1E224(SI_ARRAY(1), SI_ARRAY(3), 25, SI_VAR(0), SI_VAR(1));
...
Script N(script_802495FC) = SCRIPT({
    SI_VAR(1) = spawn N(script_80248998);
    sleep 60;
    kill SI_VAR(1);
    loop 5 {
        GetPlayerPos(SI_VAR(0), SI_VAR(1), SI_VAR(2));
    ...
    sleep 20;
    await N(script_80249520);
});

Script N(script_802496AC) = SCRIPT({
    SI_VAR(1) = spawn N(script_802494E0);
    sleep 60;
    loop 5 {
        GetPlayerPos(SI_VAR(0), SI_VAR(1), SI_VAR(2));
        SI_VAR(1) += -1;
...
Script N(script_8024975C) = {
    ...
    SI_CMD(ScriptOpcode_IF_EQ, SI_VAR(0), 1),
        ...
        SI_CMD(ScriptOpcode_AWAIT_SCRIPT, N(script_80248110)),
        SI_CMD(ScriptOpcode_SET, SI_VAR(0), 0),
        SI_CMD(ScriptOpcode_RETURN),
    SI_CMD(ScriptOpcode_END_IF),
    SI_CMD(ScriptOpcode_SET, SI_SAVE_FLAG(1793), 1),
    SI_CMD(ScriptOpcode_CALL, func_802425BC_A1D6BC),
    SI_CMD(ScriptOpcode_CALL, func_802428D0_A1D9D0),
    SI_CMD(ScriptOpcode_SPAWN, N(script_802481C0)),
    ...
    SI_CMD(ScriptOpcode_SPAWN_GET_ID, N(script_802488E8), SI_VAR(1)),
    ...
    SI_CMD(ScriptOpcode_LOOP, 0),
        ...
        SI_CMD(ScriptOpcode_SLEEP_FRAMES, 1),
    SI_CMD(ScriptOpcode_END_LOOP),
    SI_CMD(ScriptOpcode_CALL, func_80242C14_A1DD14),
    SI_CMD(ScriptOpcode_LOOP, 5),
    ...
    SI_CMD(ScriptOpcode_SPAWN, N(script_8024895C)),
    SI_CMD(ScriptOpcode_SLEEP_FRAMES, 15),
    SI_CMD(ScriptOpcode_CALL, PlaySound, 141),
    SI_CMD(ScriptOpcode_CALL, func_80242F14_A1E014, SI_VAR(0)),
    SI_CMD(ScriptOpcode_SET, SI_ARRAY(4), 0),
    SI_CMD(ScriptOpcode_CALL, func_80243508_A1E608),
    SI_CMD(ScriptOpcode_SLEEP_FRAMES, 40),
    SI_CMD(ScriptOpcode_CALL, func_80242B90_A1DC90),
    SI_CMD(ScriptOpcode_SPAWN_THREAD),
    ...
    SI_CMD(ScriptOpcode_END_SPAWN_THREAD),
    SI_CMD(ScriptOpcode_IF_EQ, SI_VAR(0), 1),
        SI_CMD(ScriptOpcode_CALL, SetNpcAnimation, 7, 0xAF0007),
        SI_CMD(ScriptOpcode_SET, SI_ARRAY(4), 1),
        SI_CMD(ScriptOpcode_SPAWN_THREAD),
            SI_CMD(ScriptOpcode_CALL, func_80242EE0_A1DFE0, 1),
            SI_CMD(ScriptOpcode_SLEEP_FRAMES, 6),
            SI_CMD(ScriptOpcode_SLEEP_FRAMES, 6),
            SI_CMD(ScriptOpcode_SLEEP_FRAMES, 6),
            SI_CMD(ScriptOpcode_CALL, func_80242EE0_A1DFE0, 2),
        SI_CMD(ScriptOpcode_END_SPAWN_THREAD),
        SI_CMD(ScriptOpcode_SPAWN_THREAD),
        ...
        SI_CMD(ScriptOpcode_CALL, func_80242FAC_A1E0AC),
        SI_CMD(ScriptOpcode_SPAWN_THREAD),
            SI_CMD(ScriptOpcode_SLEEP_FRAMES, 15),
            SI_CMD(ScriptOpcode_CALL, GetPlayerPos, SI_VAR(0), SI_VAR(1), SI_VAR(2)),
            SI_CMD(ScriptOpcode_ADD, SI_VAR(1), 50),
            SI_CMD(ScriptOpcode_CALL, func_80243124_A1E224, 0, 0, 83, SI_VAR(0), SI_VAR(2)),
            ...
            SI_CMD(ScriptOpcode_CALL, func_80243124_A1E224, 0, 0, 58, SI_VAR(0), SI_VAR(2)),
            SI_CMD(ScriptOpcode_CALL, PlayEffect, 7, 2, SI_VAR(0), SI_VAR(1), SI_VAR(2), 0, 0, 0, 0, 0, 0, 0, 0, 0),
            SI_CMD(ScriptOpcode_CALL, PlayEffect, 68, 4, SI_VAR(0), SI_VAR(1), SI_VAR(2), 1, 60, 0, 0, 0, 0, 0, 0, 0),
            SI_CMD(ScriptOpcode_SLEEP_FRAMES, 15),
            SI_CMD(ScriptOpcode_ADD, SI_VAR(1), 30),
            SI_CMD(ScriptOpcode_CALL, func_80243124_A1E224, 0, 0, 93, SI_VAR(0), SI_VAR(2)),
            SI_CMD(ScriptOpcode_CALL, PlayEffect, 7, 2, SI_VAR(0), SI_VAR(1), SI_VAR(2), 0, 0, 0, 0, 0, 0, 0, 0, 0),
            SI_CMD(ScriptOpcode_CALL, PlayEffect, 68, 4, SI_VAR(0), SI_VAR(1), SI_VAR(2), 1, 60, 0, 0, 0, 0, 0, 0, 0),
            SI_CMD(ScriptOpcode_SLEEP_FRAMES, 15),
        SI_CMD(ScriptOpcode_END_SPAWN_THREAD),
        SI_CMD(ScriptOpcode_SLEEP_FRAMES, 20),
        SI_CMD(ScriptOpcode_SPAWN_GET_ID, N(script_802495FC), SI_VAR(1)),
        SI_CMD(ScriptOpcode_ADD, SI_SAVE_VAR(352), 1),
        SI_CMD(ScriptOpcode_IF_GT, SI_SAVE_VAR(352), 63),
            SI_CMD(ScriptOpcode_CALL, ContinueSpeech, -1, -1, -1, 0, 0x80010),
            SI_CMD(ScriptOpcode_CALL, SetNpcAnimation, 7, 0xAF0006),
            SI_CMD(ScriptOpcode_LOOP, 0),
                SI_CMD(ScriptOpcode_SCRIPT_EXISTS, SI_VAR(1), SI_VAR(0)),
                SI_CMD(ScriptOpcode_IF_EQ, SI_VAR(0), 0),
                    SI_CMD(ScriptOpcode_BREAK_LOOP),
                ...
                SI_CMD(ScriptOpcode_SLEEP_FRAMES, 1),
            SI_CMD(ScriptOpcode_END_LOOP),
            SI_CMD(ScriptOpcode_CALL, SetNpcAnimation, 7, 0xAF0005),
            SI_CMD(ScriptOpcode_SET, SI_VAR(0), 348),
            SI_CMD(ScriptOpcode_SET, SI_VAR(1), 3),
            SI_CMD(ScriptOpcode_AWAIT_SCRIPT, N(script_80248020)),
            SI_CMD(ScriptOpcode_CALL, AddStarPieces, 1),
            SI_CMD(ScriptOpcode_CALL, func_80242EE0_A1DFE0, 15),
            SI_CMD(ScriptOpcode_CALL, func_80242F94_A1E094),
    ...
    SI_CMD(ScriptOpcode_ELSE),
        ...
        SI_CMD(ScriptOpcode_CALL, SetNpcAnimation, 7, 0xAF000A),
        SI_CMD(ScriptOpcode_LOOP, 0),
            SI_CMD(ScriptOpcode_SCRIPT_EXISTS, SI_VAR(1), SI_VAR(0)),
            SI_CMD(ScriptOpcode_IF_EQ, SI_VAR(0), 0),
                SI_CMD(ScriptOpcode_BREAK_LOOP),
        ...
        SI_CMD(ScriptOpcode_SET, SI_VAR(0), 0),
    SI_CMD(ScriptOpcode_END_IF),
    SI_CMD(ScriptOpcode_CALL, func_80242F14_A1E014, -1),
    ...
    SI_CMD(ScriptOpcode_END_SPAWN_THREAD),
    SI_CMD(ScriptOpcode_CALL, func_80242FC8_A1E0C8),
    SI_CMD(ScriptOpcode_CALL, func_80242E2C_A1DF2C),
    SI_CMD(ScriptOpcode_AWAIT_SCRIPT, N(script_80248110)),
    SI_CMD(ScriptOpcode_SPAWN, N(script_80248458)),
    SI_CMD(ScriptOpcode_CALL, func_80242A1C_A1DB1C),
    SI_CMD(ScriptOpcode_CALL, func_802425D0_A1D6D0),
...
Script N(script_8024A48C) = SCRIPT({
    func_802425E0_A1D6E0();
    if (SI_VAR(0) == 0) {
        return;
    }
    SetNpcFlagBits(-1, 0x1000000, 0);
    func_802CF208(-1, 0xAF0001);
    func_80242804_A1D904();
});

// Unable to use DSL: DSL does not support script opcode 0x3C
Script N(script_8024A500) = {
    SI_CMD(ScriptOpcode_USE_ARRAY, D_8024BDD8),
    ...
    SI_CMD(ScriptOpcode_AWAIT_SCRIPT, N(script_8024975C)),
...
Script N(script_8024A580) = SCRIPT({
    func_80242850_A1D950();
});
...
Script N(script_8024A5CC) = SCRIPT({
    DoBasicAI(N(aISettings_8024A59C));
});
...
NpcSettings N(npcSettings_8024A5EC) = {
    ...
    .height = 0x23,
    .radius = 0x1C,
    .otherAI = &N(script_8024A48C),
    .onInteract = &N(script_8024A500),
    .ai = NULL,
    .onHit = NULL,
    .aux = &N(script_8024A580),
    .onDefeat = NULL,
    .flags = 0xD01,
    .unk_24 = { 0, 0, 0, 0 },
    .level = 0x63,
...
s32 unk_missing_8024A618[] = {
    0x00AF0001, 0x0023001C, N(script_8024A48C), N(script_8024A500), N(script_8024A5CC), 0x00000000, N(script_8024A580), 0x00000000,
    0x00000C01, 0x00000000, 0x00630010,
};

Script N(script_Interact_8024A644) = SCRIPT({
    SpeakToPlayer(-1, 0xB30002, 0xB30001, 0, 0xA005F);
});

Script N(script_Init_8024A674) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_8024A644));
});

Script N(script_Interact_8024A698) = SCRIPT({
    SpeakToPlayer(-1, 0xB30002, 0xB30001, 0, 0xA0060);
});

Script N(script_Init_8024A6C8) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_8024A698));
});

Script N(script_Interact_8024A6EC) = SCRIPT({
    SpeakToPlayer(-1, 0xB30002, 0xB30001, 0, 0xA0061);
});

Script N(script_Init_8024A71C) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_8024A6EC));
});

Script N(script_Interact_8024A740) = SCRIPT({
    SpeakToPlayer(-1, 0xB30002, 0xB30001, 0, 0xA0062);
});

Script N(script_Init_8024A770) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_8024A740));
});

Script N(script_Interact_8024A794) = SCRIPT({
    SpeakToPlayer(-1, 0xB30002, 0xB30001, 0, 0xA0063);
});

Script N(script_Init_8024A7C4) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_8024A794));
});

Script N(script_8024A7E8) = SCRIPT({
    spawn N(script_8024365C);
    spawn {
        sleep 20;
        func_8024226C_A1D36C(0, 40);
        SetCamType(0, 4, 0);
...
Script N(script_8024AA1C) = SCRIPT({
    spawn N(script_80243630);
    func_8024226C_A1D36C(0, 25);
    func_802D2520(0x10002, 0, 0, 0, 0, 0);
    SetPlayerPos(445, 25, 185);
    PlayerMoveTo(440, 215, 20);
});

Script N(script_8024AAA0) = SCRIPT({
    SI_VAR(0) = 0xA0064;
    SI_VAR(8) = 0xA0065;
    SI_VAR(1) = 0xA0066;
    SI_VAR(2) = 0xA0067;
...
Script N(script_Init_8024AB00) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_80247C74));
});

Script N(script_Interact_8024AB24) = SCRIPT({
    await func_80284054;
});

Script N(script_Init_8024AB40) = SCRIPT({
    BindNpcInteract(-1, N(script_Interact_8024AB24));
});
...
StaticNpc N(npcGroup_8024AB64)[] = {
    {
        ...
        .pos = { -463.0, 10.0, 400.0 },
        .flags = 0x00000D09,
        .init = N(script_Init_8024A674),
        .yaw = 270,
        .dropFlags = 0x80,
        .animations = {
            0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001,
        },
        .tattle = 0x1A010E,
    },
    {
        .id = 1,
        .settings = &N(npcSettings_802457C8),
        .pos = { -325.0, 10.0, 600.0 },
        .flags = 0x00000D09,
        .init = N(script_Init_8024A6C8),
        .yaw = 270,
        .dropFlags = 0x80,
        .animations = {
            0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001,
    ...
    },
    {
        ...
        .pos = { 0.0, 10.0, 300.0 },
        .flags = 0x00000D09,
        .init = N(script_Init_8024A71C),
        .yaw = 270,
        .dropFlags = 0x80,
        .movement = { 0x00000000, 0x0000000A, 0x0000012C, 0x0000001E, 0x00000000, 0xFFFF8001, 0x00000000, 0x00000000, 0x0000000A, 0x0000012C, 0x0000001E, 0x00000000, 0x00000000, 0x00000001 },
        .animations = {
            0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001,
        },
        .tattle = 0x1A0110,
    },
    {
        .id = 3,
        .settings = &N(npcSettings_80245904),
        .pos = { 250.0, 10.0, 500.0 },
        .flags = 0x00000D09,
        .init = N(script_Init_8024A770),
        .yaw = 270,
        .dropFlags = 0x80,
        .movement = { 0x000000FA, 0x0000000A, 0x000001F4, 0x0000001E, 0x00000000, 0xFFFF8001, 0x00000000, 0x000000FA, 0x0000000A, 0x000001F4, 0x0000001E, 0x00000000, 0x00000000, 0x00000001 },
        .animations = {
            0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001,
        },
        .tattle = 0x1A0111,
    },
    {
        .id = 4,
        .settings = &N(npcSettings_802457C8),
        .pos = { -485.0, 335.0, -100.0 },
        .flags = 0x00000D09,
        .init = N(script_Init_8024A7C4),
        .yaw = 270,
        .dropFlags = 0x80,
        .animations = {
            0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001,
    ...
    },
    {
        .id = 5,
        .settings = &N(npcSettings_802457C8),
        .pos = { 458.0, 35.0, 233.0 },
        .flags = 0x00000D09,
        .init = N(script_Init_8024AB00),
        .yaw = 270,
        .dropFlags = 0x80,
        .animations = {
            0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001,
    ...
    },
    {
        .id = 6,
        .settings = &N(npcSettings_802457C8),
        .pos = { 140.0, 285.0, -315.0 },
        .flags = 0x00000D09,
        .init = N(script_Init_8024AB40),
        .yaw = 270,
        .dropFlags = 0x80,
        .animations = {
            0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001, 0x00B30001,
...
NpcGroupList N(npcGroupList_8024BAE4) = {
    NPC_GROUP(N(npcGroup_8024AB64), 0x00000000),
    {},
};
...
s32 N(intTable_8024BB00)[] = {
    0x002700A5, 0x002700A6, 0x002700A7, 0x002700A8, 0x002700A9, 0x002700AA, 0x002700AB, 0x002700AC,
    0x002700AD, 0x002700AE, 0x002700AF, 0x002700B0, 0x002700B1, 0x002700B2, 0x002700B3, 0x002700B4,
    0x002700B5, 0x002700B6, 0x002700B7, 0x002700B8, 0x002700B9, 0x002700BA, 0x002700BB,
};

s32 N(shopInventory_8024BB5C)[] = {
    0x00000092, 0x0000000F, 0x00240028, 0x00000083, 0x0000000F, 0x00240004, 0x0000009B, 0x00000003,
    0x0024000F, 0x000000A3, 0x0000000A, 0x00240017, 0x00000095, 0x00000019, 0x0024000C, 0x0000008C,
    0x0000000A, 0x0024000A, 0x00000000, 0x00000000, 0x00000000,
};

s32 N(shopPriceList_8024BBB0)[] = {
    0x000000A7, 0x00000007, 0x00000000, 0x00000082, 0x0000000F, 0x00000000, 0x00000083, 0x0000000E,
    0x00000000, 0x000000CA, 0x0000000F, 0x00000000, 0x0000008F, 0x0000000A, 0x00000000, 0x000000C1,
    0x0000000F, 0x00000000, 0x00000092, 0x0000000E, 0x00000000, 0x000000B5, 0x0000000F, 0x00000000,
    0x000000B7, 0x0000001E, 0x00000000, 0x000000BA, 0x00000046, 0x00000000, 0x00000000, 0x00000000,
    0x00000000,
};

Script N(script_8024BC34) = SCRIPT({
    match SI_VAR(0) {
        == 3 {}
        == 4 {}
        == 1 {}
...
s32 N(shopItemPositions_8024BC88)[] = {
    0x003E002B, 0x003F002C, 0x0040002D, 0x0041002E, 0x0042002F, 0x00430030,
};

s32 N(shopOwnerNPC_8024BCA0)[] = {
    0x00000006, 0x00B30001, 0x00B30002, N(script_8024BC34), 0x00000000, 0x00000000, N(intTable_8024BB00),
};
...
Script N(script_MakeEntities) = SCRIPT({
    MakeEntity(D_802E9A18, 200, 60, 275, 0, 0x80000000);
    func_80111E9C(3);
});
...
// rodata: D_8024BD50_A26E50

// rodata: D_8024BD58_A26E58

// rodata: D_8024BD60_A26E60

s32 pad_00BD68[] = {
    0x00000000, 0x00000000,
};

// rodata: D_8024BD70_A26E70

// rodata: D_8024BD78_A26E78

// rodata: D_8024BD80_A26E80

// rodata: jtbl_8024BD88_A26E88
